...
<head lang="en" data-fb_pixel_id="<?=fb_pixel_id();?>">
    ...
    <link href="<?=base_url('assets\css\toastr.min.css');?>" rel="stylesheet">
...
<body data-base_url="<?=base_url();?>" data-s3_url = "<?=get_s3_imgpath_upload()?>" data-placeholder_img="<?=placeholder_img();?>" data-primary-color = "<?=$primaryColor_accent?>">

<?php $this->load->view('includes/cover');?>
<header class="pop_up_after">
        ...
        <div class="container">
            <div class="row row-mid">
                ...
                <div class="col-auto ml-auto d-flex align-items-center cartHolder">
                            ...
                            <div class="shipped_to_main_wrapper" id="shipped_to_main">
                               ...
                               <a class="ttm-menu-font  shipped_to_main_wrapper_text"  data-toggle="dropdown" href="#">
                                  ...
                                  <span id = "header-location"> 
                                    <?php if($this->session->userdata("shipping_location")!=""){
                                        echo $this->session->userdata("shipping_location");
                                    }else{
                                        echo "Philippines";
                                    }?> 
                                    </span> 
                                    ...
                                    <?php if($this->session->userdata("shipping_location")!=""){
                                        $exp = explode(",", $this->session->userdata("shipping_location"));
                                        echo $exp[1];
                                    }else{
                                        echo "Philippines";
                                    }?> 
                                  ...
                                  <select class="select2 shipped-to-main-city" style = "width:auto !important;">
                    ...
                    <?php } else { ?>
                        <a href="<?=base_url('user/profile')?>" class="mr-3 middle__user" style="white-space:nowrap;"><i class="fa fa-user-circle mr-2"></i><?= $this->session->userdata("fname");?></a>
                    <?php } ?>
                    <?php
                ...
                <div class="col-5 col-md-12">
                    <?php
                        foreach ($categories as $category) {?>
                            <a href="<?=base_url('/search?keyword=' . $category['category_name']);?>" class="header__category__item"><span><?=$category['category_name']?></span></a>
                        <?php } ?>
                </div>
                <?php }?>
...
<input id="get_shipping_locs" value="<?php echo $this->session->userdata("get_shipping_locs");?>" hidden/>
