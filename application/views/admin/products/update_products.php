    ...
    <div class="alert alert-secondary ml-4 color-dark" role="alert">
        ...
        <span class="font-weight-regular">
            ...
            <?php }else if($next_product != ''){?>
                <a href="<?=base_url('admin/Main_products/update_products/'.$token.'/'.$next_product)?>" type="button" class="nextBtn mx-3" id="nextBtn"><i class="fa fa-arrow-right"></i><?=$next_product?></a>
            <?php } else {?>
                <a  type="button" class="nextBtn mx-3 text-dark" id="nextBtn"><?=$Id?></a>
            <?php } ?>
        </span>
