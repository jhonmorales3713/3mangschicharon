                        ...
                        <form id="form_discount"name="form_discount" enctype="multipart/form-data" method="post">
                            <div class="card-body center">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <label for="date_issue" class="control-label">Date Issue: </label> 
                                        <input type="date"  class="form-control" style="z-index: 2 !important; text-align:center;" value="<?=date('Y-m-d',time())?>" id="date_from" name="date_from" placeholder="MM/DD/YYYY">
                                    </div>
                                    <div class="col">
                                        <label for="date_valid" class="control-label">Valid Until:</label>    
                                        <input type="date" class="form-control" style="z-index: 2 !important; text-align:center;" value="<?=date('Y-m-d',time())?>" id="date_to" name="date_to" placeholder="MM/DD/YYYY" >
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label for="date_valid" class="control-label discount_type_label" id="disc_amount_label">Discount Amount:</label> 
                                            <input type="number" class="form-control required_fields allownumericwithdecimal" name="disc_ammount" id="disc_ammount"  size="50">
                                    </div>
                                </div>
                                    <div class="row" >
                                        <div class="col">
                                            <div class="input-group" >
                                                <label for="set_max_amount" class="control-label"><input type="checkbox" id="set_max_amount" name="set_max_amount"  value="1">Set Maximum Discount Price</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                                    ...
                                    <div class="row" style="display: none;" id="maximum_discount_price">
                                        <div class="col">
                                            <div class="form-group">
                                                    ...
                                                    <input  type="number" class="form-control required_fields allownumericwithdecimal" name="disc_ammount_limit" id="disc_ammount_limit"  size="10">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" >
                                        ...
                                        <!-- <div class="col">
                                                ...
                                                <input type="number" class="form-control required_fields allownumericwithoutdecimal" name="usage_quantity" id="usage_quantity">
                                        </div> -->
                                    </div>
                                ...
                                <div class="form-group row mt-10">       
                                        <div class="col-md-12">
                                            <button style="float:right" type="button" class="btn btn-primary saveBtn">Save</button>
                                        </div>
                                </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/libs/admin/promotions/add_product_discount.js');?>"></script>
