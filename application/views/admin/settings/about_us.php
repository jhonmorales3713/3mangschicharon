...
<div class="col-12 pl-5">
    <div class="alert alert-secondary color-dark" role="alert">
        ...
        &nbsp;<span class="fa fa-chevron-right"></span>&nbsp;
        <span class="font-weight-regular">About Us</span>
...
<div class="col-12 bg-white pl-5">
    <table class="table wrap-btn-last-td  table-striped table-hover table-bordered display nowrap" id="tblaboutus"  style="width:100%" cellpadding="0" cellspacing="0" border="0">
        <thead>
            <tr>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header secondary-bg white-text d-flex align-items-center">
                <h3 class="modal-title" id="add_update_title">Add Info</h3>
            </div>
            <div class="modal-body">
                <form name="form_aboutus" id="form_aboutus" method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnSaveaboutus">Save</button>
            </div>
        </div>
    </div>
</div>
...
<br>
<script type="text/javascript" src="<?=base_url('assets/js/libs/admin/settings/about_us.js');?>"></script>