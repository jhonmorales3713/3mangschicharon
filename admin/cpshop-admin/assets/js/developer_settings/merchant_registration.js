$(function () {
	...
	function fillDatatable() {
		...
		var c_conno = $("input[name='c_conno']").val();
		...
		var dataTable = $('#table-grid').DataTable({
			...
			"columnDefs": [
				...
				{ targets: [0, 1, 2, 3, 4], orderable: true, "sClass": "text-center" },
				{ responsivePriority: 1, targets: 0 }, { responsivePriority: 2, targets: -1 }
			],
			"ajax": {
				type: "post",
				url: base_url + "developer_settings/Shops_merchant_registration/merchant_registration_table", // json datasource
				data: { '_record_status': _record_status, 'c_name': c_name, 'c_email': c_email, 'c_conno': c_conno }, // serialized dont work, idkw
	...
	$("#delete_modal_confirm_btn").click(function(e){
		...
		$.ajax({
			type:'post',
			url:base_url+'developer_settings/Shops_merchant_registration/delete_modal_confirm',
