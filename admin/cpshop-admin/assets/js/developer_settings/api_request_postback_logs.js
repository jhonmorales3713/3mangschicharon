$(function () {
	...
	function fillDatatable() {
		var _details = $("input[name='_details']").val();
		var type = $("#select_type").val();
		var date_from = $("#date_from").val();
		var date_to = $("#date_to").val();

		var filters = {
			_details: $("input[name='_details']").val(),
		...
		var dataTable = $('#table-grid').DataTable({
			...
			"ajax": {
				type: "post",
				url: base_url + "developer_settings/Dev_settings_api_request_postlog/api_request_postback_logs_table", // json datasource
				data: {'_details': _details, 'type': type, 'date_from': date_from, 'date_to': date_to }, // serialized dont work, idkw
