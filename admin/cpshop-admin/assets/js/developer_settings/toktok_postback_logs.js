$(function () {
	...
	function fillDatatable() {
		...
		var dataTable = $('#table-grid').DataTable({
			...
			"ajax": {
				type: "post",
				url: base_url + "developer_settings/Dev_settings/postback_logs_tbl", // json datasource
				data: { 'search': search, 'date_from': date_from, 'date_to': date_to }, // serialized dont work, idkw
