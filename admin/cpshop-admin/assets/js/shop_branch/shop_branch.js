$(function(){
	...
	function fillDatatable(){
		...
		var _mainshop 	= $("select[name='_mainshop']").val();
		var _city 	= $("select[name='_city']").val();
		var _branchname		= $("input[name='_branchname']").val();
		...
		var dataTable = $('#table-grid').DataTable({
			...
			"ajax":{
				type: "post",
				url:base_url+"Shopbranch/list", // json datasource
				data:{'_record_status':_record_status, '_mainshop':_mainshop, '_branchname':_branchname, '_city':_city}, // serialized dont work, idkw
				beforeSend:function(data) {
					$.LoadingOverlay("show"); 
				},
				complete: function(res) {
					var filter = {'_record_status':_record_status, '_mainshop':_mainshop, '_branchname':_branchname, '_city':_city};
					$.LoadingOverlay("hide"); 
	...
	$("#delete_modal_confirm_btn").click(function(e){
		...
		$.ajax({
			type:'post',
			url:base_url+'Shopbranch/deactivate',
