...
var edit_loadstate = false;
    ...
    $.ajax({
        method: "POST",
        url: base_url+'promotion/Main_promotion/check_voucher_code/'+voucher_code,
            success: function(data){

            // alert(data);
            if(data == 1) { 
                showCpToast("warning", "Warning!", 'Voucher Code already exist!');            
                // $.toast({
                //     text: 'Warning!<br>Voucher Code already exist!',
                //     icon: 'info',
                //     loader: false,  
                //     stack: false,
                //     position: 'top-center', 
                ...
                // });
                    ...
                    if($('#product_id').val() == '' && $('#shop_id').val() == '' ){
                        ...
                        $.ajax({
                            type:'post',
                            url: base_url+'promotion/Main_promotion/save_voucher',
                            data: form_data,
                            processData: false,
                            contentType: false,
                            ...
                            success:function(data){
                                ...
                                if (data.success == 1) {
                                    ...
                                    showCpToast("success", "Success!", "Record added successfully!");
