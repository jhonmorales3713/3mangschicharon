$(function(){
	...
	function fillDatatable(){
		...
		var dataTable = $('#table-grid').DataTable({
			...
			"ajax":{
				type: "post",
				url:base_url+"Region/list", // json datasource
				data:{'_record_status':_record_status, '_code':_code, '_name':_name}, // serialized dont work, idkw
				beforeSend:function(data) {
					$.LoadingOverlay("show"); 
				},
				complete: function(res) {
					var filter = {'_record_status':_record_status, '_code':_code, '_name':_name};
					$.LoadingOverlay("hide"); 
	...
	$("#delete_modal_confirm_btn").click(function(e){
		...
		$.ajax({
			type:'post',
			url:base_url+'Region/deactivate',
