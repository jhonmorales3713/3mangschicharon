$(function () {
	...
	$('#overall_access').change(function(e){
		if($(this).is(':checked') == true){
			...
			$("#shop_mcr_sch_view").prop('checked', false);
			$("#shop_mcr_sch_delete").prop('checked', false);
			$("#shop_mcr_sch_view_shop").prop('checked', false);

			$("#shop_popup_view").prop('checked', false);
			$("#shop_popup_create").prop('checked', false);
			$("#shop_popup_update").prop('checked', false);
			$("#shop_popup_delete").prop('checked', false);
...
function populate_edit_user_form(data) {
	...
	if(data.functions != "") {
		...
		if(('transactions' in fn) && fn.transactions.modify == 1) {
			$('.ac_modify').prop('checked', true);
		}
		...
		if(('products_main_category' in fn) && fn.products_main_category.view == 1) {
			$('#ac_products_category_view').prop('checked', true);
		}
		if(('products_main_category' in fn) && fn.products_main_category.create == 1) {
			$('#ac_products_category_create').prop('checked', true);
		}
		if(('products_main_category' in fn) && fn.products_main_category.update == 1) {
			$('#ac_products_category_update').prop('checked', true);
		}
		if(('products_main_category' in fn) && fn.products_main_category.delete == 1) {
			$('#ac_products_category_delete').prop('checked', true);
		}

		if(('products_main_category' in fn) && fn.products_main_category.disable == 1) {
		...
		//shop mcr schecduling
		if(('shop_mcr_scheduling' in fn) && fn.shop_mcr_scheduling.view == 1) {
			$('#shop_mcr_sch_view').prop('checked', true);
		}

		if(('shop_mcr_scheduling' in fn) && fn.shop_mcr_scheduling.delete == 1) {
			$('#shop_mcr_sch_delete').prop('checked', true);
		}

		if(('shop_mcr_scheduling' in fn) && fn.shop_mcr_scheduling.view == 1) {
			$('#shop_mcr_sch_view_shop').prop('checked', true);
		}

		//shop mcr approval
		if(('shop_mcr' in fn) && fn.shop_mcr.view == 1) {
			$('#shop_mcr_view').prop('checked', true);
		}
		//access view
		if(('shop_mcr' in fn) && fn.shop_mcr.wfa_view == 1) {
			$('#shop_mcr_wfa_view').prop('checked', true);
		}
		if(('shop_mcr' in fn) && fn.shop_mcr.approve_view == 1) {
			$('#shop_mcr_approve_view').prop('checked', true);
		}
		if(('shop_mcr' in fn) && fn.shop_mcr.decline_view == 1) {
			$('#shop_mcr_decline_view').prop('checked', true);
		}
		if(('shop_mcr' in fn) && fn.shop_mcr.verified_view == 1) {
			$('#shop_mcr_verified_view').prop('checked', true);
		}
       //access button
	   if(('shop_mcr' in fn) && fn.shop_mcr.approve == 1) {
			$('#shop_mcr_approve').prop('checked', true);
		}
		if(('shop_mcr' in fn) && fn.shop_mcr.verify == 1) {
			$('#shop_mcr_verify').prop('checked', true);
		}
		if(('shop_mcr' in fn) && fn.shop_mcr.decline == 1) {
			$('#shop_mcr_decline').prop('checked', true);
		}
		if(('shop_mcr' in fn) && fn.shop_mcr.edit == 1) {
			$('#shop_mcr_edit').prop('checked', true);
		}
		...
		// Shop Pop up image
		if(('shop_popup' in fn) && fn.shop_popup.view == 1) {
			$('#shop_popup_view').prop('checked', true);
		}
		if(('shop_popup' in fn) && fn.shop_popup.create == 1) {
			$('#shop_popup_create').prop('checked', true);
		}
		if(('shop_popup' in fn) && fn.shop_popup.update == 1) {
			$('#shop_popup_update').prop('checked', true);
		}
		if(('shop_popup' in fn) && fn.shop_popup.disable == 1) {
			$('#shop_popup_disable').prop('checked', true);
		}
		if(('shop_popup' in fn) && fn.shop_popup.delete == 1) {
			$('#shop_popup_delete').prop('checked', true);
		}


		// Faqs CMS
		if(('faqs' in fn) && fn.faqs.view == 1) {
			$('#faqs_view').prop('checked', true);
		}
		if(('faqs' in fn) && fn.faqs.create == 1) {
			$('#faqs_create').prop('checked', true);
		}
		if(('faqs' in fn) && fn.faqs.update == 1) {
			$('#faqs_update').prop('checked', true);
		}
		if(('faqs' in fn) && fn.faqs.disable == 1) {
			$('#faqs_disable').prop('checked', true);
		}
		if(('faqs' in fn) && fn.faqs.delete == 1) {
			$('#faqs_delete').prop('checked', true);
		}
		...
		if(('rec_vc' in fn) && fn.rec_vc.view == 1) {
			$('#ac_reclaimed_vouchers_list_view').prop('checked', true);
		}
		...
		if(('mystery_coupon' in fn) && fn.mystery_coupon.view == 1) {
			$('#pr_mystery_coupon_view').prop('checked', true);
		}
		if(('mystery_coupon' in fn) && fn.mystery_coupon.create == 1) {
			$('#pr_mystery_coupon_create').prop('checked', true);
		}
		if(('mystery_coupon' in fn) && fn.mystery_coupon.update == 1) {
			$('#pr_mystery_coupon_update').prop('checked', true);
		}
		if(('mystery_coupon' in fn) && fn.mystery_coupon.delete == 1) {
			$('#pr_mystery_coupon_approve').prop('checked', true);
		}
		if(('mystery_coupon' in fn) && fn.mystery_coupon.approve == 1) {
			$('#pr_mystery_coupon_disable').prop('checked', true);
		}
		if(('mystery_coupon' in fn) && fn.mystery_coupon.disable == 1) {
			$('#pr_mystery_coupon_delete').prop('checked', true);
		}

		// Shipping Fee Discount 

		if(('sf_discount' in fn) && fn.sf_discount.view == 1) {
			$('#pr_sfd_view').prop('checked', true);
		}
		if(('sf_discount' in fn) && fn.sf_discount.create == 1) {
			$('#pr_sfd_create').prop('checked', true);
		}
		if(('sf_discount' in fn) && fn.sf_discount.update == 1) {
			$('#pr_sfd_update').prop('checked', true);
		}
		if(('sf_discount' in fn) && fn.sf_discount.delete == 1) {
			$('#pr_sfd_delete').prop('checked', true);
		}


		// Campaign Type

		if(('campaign_type' in fn) && fn.campaign_type.view == 1) {
			$('#pr_campaign_type_view').prop('checked', true);
		}
		if(('campaign_type' in fn) && fn.campaign_type.create == 1) {
			$('#pr_campaign_type_create').prop('checked', true);
		}
		if(('campaign_type' in fn) && fn.campaign_type.update == 1) {
			$('#pr_campaign_type_update').prop('checked', true);
		}
		if(('campaign_type' in fn) && fn.campaign_type.delete == 1) {
			$('#pr_campaign_type_delete').prop('checked', true);

		}
		//Promotion
		// Voucher Discount 

		if(('voucher_discount' in fn) && fn.voucher_discount.view == 1) {
			$('#voucher_discount_view').prop('checked', true);
		}
		if(('voucher_discount' in fn) && fn.voucher_discount.create == 1) {
			$('#voucher_discount_create').prop('checked', true);
		}
		if(('voucher_discount' in fn) && fn.voucher_discount.update == 1) {
			$('#voucher_discount_update').prop('checked', true);
		}
		if(('voucher_discount' in fn) && fn.voucher_discount.delete == 1) {
			$('#voucher_discount_delete').prop('checked', true);
		}
		if(('voucher_discount' in fn) && fn.voucher_discount.disable == 1) {
			$('#voucher_discount_disable').prop('checked', true);
		}
