$(function () {
	...
	function fillDatatable() {
		...
		var dataTable = $("#table-grid").DataTable({
			...
			searching: false,
			serverSide: true,
			columnDefs: [{ targets: 3, orderable: false, sClass: "text-center" }, { responsivePriority: 1, targets: 0 }, { responsivePriority: 2, targets: -1 }],
			ajax: {
				type: "post",
				url:
					base_url +
					"shipping_delivery/Settings_shipping_delivery/general_table", // json datasource
