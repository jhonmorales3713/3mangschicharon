$(function () {
	...
	function fillDatatable() {
		...
		var dataTable = $("#table-grid-order").DataTable({
			...
			order: [[ 0, "desc" ]],
			columnDefs: [
				{ targets: [8, 9], orderable: false, sClass: "text-center" },
				{ responsivePriority: 1, targets: 0 },
				{ responsivePriority: 2, targets: -1 },
			],
			ajax: {
				type: "post",
				url: base_url + "orders/Main_orders_toktokmall/order_table", // json datasource
				data: {
	...
	$("#delete_modal_confirm_btn").click(function (e) {
		...
		$.ajax({
			type: "post",
			url: base_url + "orders/Main_orders_toktokmall/delete_modal_confirm",
	...
	$("#disable_modal_confirm_btn").click(function (e) {
		...
		$.ajax({
			type: "post",
			url: base_url + "orders/Main_orders_toktokmall/disable_modal_confirm",
