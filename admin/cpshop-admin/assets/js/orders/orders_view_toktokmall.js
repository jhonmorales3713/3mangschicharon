$(function(){
    ...
    var fillDataTableProducts = function(reference_num) {
        dataTable = $('#table-item').DataTable({
            ...
            responsive: true,
            "ajax":{
                url:base_url+"orders/Main_orders_toktokmall/order_item_table", // json datasource
    ...
    $('#update-branches').click(function(e){
        ...
        if(checkShopActve() == 1){
            ...
            if(old_branchid == new_branchid){
                ...
                $.ajax({
                    type:'post',
                    url:base_url+'orders/Main_orders_toktokmall/check_reassign_item',
                    data:{
    ...
    $('#check_update-branches').click(function(e){
        ...
        $.ajax({
            type:'post',
            url:base_url+'orders/Main_orders_toktokmall/reassign_branch',
            data:{
                'mainshopid':$('.reassignBtn').data('value'), 
                'reference_num':$('.reassignBtn').data('reference_num'),
                'branchid':$('#shop-branches').val(), 
    ...
    $('#cancelOrderBtn').click(function(e){
        ...
        if(checkShopActve() == 1){
            ...
            $.ajax({
                type:'post',
                url:base_url+'orders/Main_orders_toktokmall/getDeliveryCancellationCategories',
                data:{
    ...
    $('#form_save_payment').submit(function(e){
        ...
        if(parseFloat(paid_amount) != parseFloat(total_amount) && payment_isset == true){
            ...
            $.ajax({
                type: form[0].method,
                url: base_url+"orders/Main_orders_toktokmall/payOrder",
                data: form_data,
                contentType: false,   
                cache: false,      
                processData:false,
                success:function(data){
                    ...
                    if(json_data.success) {
                        ...
                        window.location.assign(base_url+"Main_orders_toktokmall/orders/"+token);
                    }else{
    ...
    $('#form_save_process').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/processOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_ready_pickup').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/readyPickupOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_cancel_order').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/cancelOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_booking_confirm').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/bookingConfirmOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_fulfillment').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/FulfilledOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_returntosender').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/returntosenderOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_redeliver').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/redeliverOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_shipped').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/shippedOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    $('#form_save_confirmed').submit(function(e){
        ...
        $.ajax({
            type: form[0].method,
            url: base_url+"orders/Main_orders_toktokmall/confirmedOrder",
            data: form_data,
            contentType: false,   
            cache: false,      
            processData:false,
    ...
    function get_shop_branches(mainshopid, branchid){
        $.ajax({
            type:'post',
            url:base_url+'orders/Main_orders_toktokmall/get_shop_branches',
    ...
    $('#printBtn').click(function(e){
        ...
        window.open(base_url+'Main_orders/print_order_merchant/'+token+'/'+reference_num, '_blank');
    });
