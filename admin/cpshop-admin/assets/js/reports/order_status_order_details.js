$(function(){
    ...
    var is_manual_order = $('#is_manual_order').val();
      ...
      var filter = {        
        ...
        order_status: $("#order_status_label label").html()
      };
      ...
      function fillDataTable() {
        var to = $('#table-grid').DataTable({
          ...
          "ajax": {
            url: base_url + 'reports/Order_status/order_details_table/'+reference_num+'/'+is_manual_order,
            type: 'post',
            data: filter,
            beforeSend: function () {
              $.LoadingOverlay("show");          
            ...
            complete: function (data) {
                ...
                if(response.data.length > 0){
                  ...
                  $('#t_stotal').html(response.t_stotal);
                  $('#t_amount').html(response.t_amount);                                  
                }
                else{
                  //data_toggle("hide");
                  //$('#chart_toggle').hide();
            ...
            error: function () {  // error handling
              ...
              $("#table-grid").append('<tbody class="table-grid-error"><tr><th colspan="8"><center>No data found in the server</center></th></tr></tbody>');
