$(function(){
    ...
    var filter = {
      ...
      datetype: $('#select_date').children("option:selected").val(),
    ...
    function fillDataTable() {
      var aov = $('#table-grid').DataTable({
        ...
        "ajax": {
          url: base_url + 'reports/Order_and_sales/get_order_and_sales_table',
          type: 'post',
          data: filter,
          beforeSend: function () {
            $.LoadingOverlay("show");          
    ...
    $(document).on('click', '#btnSearch', function(){
      ...
      filter.datetype = $('#select_date').children("option:selected").val();
      filter.pmethodtype = $('#pmethodtype').val();
      ($('#select_date').children("option:selected").val() == 'date_ordered') ? $('#datetype_label').text('Date Ordered') : $('#datetype_label').text('Payment Date');
      chart();
      fillDataTable();
    });
