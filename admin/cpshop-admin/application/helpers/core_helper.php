...
function youtube_link(){
	return (cs_clients_info()) ? cs_clients_info()->c_social_media_youtube_link : "";
}

function faqs_link(){
	return (cs_clients_info()) ? cs_clients_info()->c_faqs_link : "";
}
...
function c_ofps(){
	return (cs_clients_info()) ? cs_clients_info()->c_ofps : 0;
}

function c_whtax_percentage(){
	return (cs_clients_info()) ? cs_clients_info()->c_whtax_percentage : 0;
}
...
function main_logo() {
	return get_s3_imgpath_upload()."assets/img/".((cs_clients_info()) ? cs_clients_info()->c_main_logo : "");
}

function main_logo_webp(){
	return get_s3_imgpath_upload()."assets/img/webp/".pathinfo(((cs_clients_info()) ? cs_clients_info()->c_main_logo : ""), PATHINFO_FILENAME).".webp";
}

function secondary_logo() {
	return get_s3_imgpath_upload()."assets/img/".((cs_clients_info()) ? cs_clients_info()->c_secondary_logo : "");
}

function secondary_logo_webp() {
	return get_s3_imgpath_upload()."assets/img/webp/".pathinfo(((cs_clients_info()) ? cs_clients_info()->c_secondary_logo : ""), PATHINFO_FILENAME).".webp";
}

function placeholder_img() {
	return get_s3_imgpath_upload()."assets/img/".((cs_clients_info()) ? cs_clients_info()->c_placeholder_img : "");
}
...
function cp_id(){
	return (cs_utilities()) ? cs_utilities()->id : "";
}
...
function c_paypanda_link(){
	$c_paypanda_link = "";
	switch (ENVIRONMENT){
		case 'development': $c_paypanda_link = (cs_utilities()) ? cs_utilities()->c_paypanda_link_live  : ""; break;
		case 'testing'    : $c_paypanda_link = (cs_utilities()) ? cs_utilities()->c_paypanda_link_live  : ""; break;
...
function c_paypanda_test(){
	...
	switch (ENVIRONMENT){
		...
		case 'production' : $c_paypanda_link = (cs_utilities()) ? cs_utilities()->c_paypanda_link_test  : ""; break;
	}
...
function c_allowed_jcfulfillment_prefix(){
	return (cs_utilities()) ? cs_utilities()->c_allowed_jcfulfillment_prefix : "";
}

function shop_main_announcement(){
	return (cs_utilities()) ? cs_utilities()->shop_main_announcement : "";
}
...
function gets3_bucketfolder(){
	$string = explode(".com/", get_s3_imgpath_upload());
	return $string[1];
}
...
function c_international(){
	return (cs_clients_info()) ? cs_clients_info()->c_international : "";
}

function get_pusher_app_key(){
	switch (ENVIRONMENT){
		case 'development': $directory = (cs_clients_info()) ? cs_clients_info()->c_pusher_app_key_local : ""; break;
		case 'testing'    : $directory = (cs_clients_info()) ? cs_clients_info()->c_pusher_app_key_test  : ""; break;
		case 'production' : $directory = (cs_clients_info()) ? cs_clients_info()->c_pusher_app_key_live  : ""; break;
		default           : $directory = "";
	}
	return $directory;
}
...
function get_google_api_key(){
	return (cs_clients_info()) ? cs_clients_info()->c_google_api_key : "";
}

function c_popup_img(){
	return (cs_clients_info()) ? cs_clients_info()->c_popup_img : "";
}

function c_popup_isset(){
	return (cs_clients_info()) ? cs_clients_info()->c_popup_isset : 0;
}

function c_popup_link(){
	return (cs_clients_info()) ? cs_clients_info()->c_popup_link : '';
}
