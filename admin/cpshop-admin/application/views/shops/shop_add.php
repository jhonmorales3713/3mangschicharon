    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <?php if($this->session->userdata('sys_shop') == 0){ ?>
                <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Shops/profile/'.$token);?>">Shops Profile</a></li>
                <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <?php }?>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div id="pac-container">
                                                            <label for="">Pin Address <span class="asterisk"></span></label>
                                                            <input id="pin_address" type="text" placeholder="Search" class = "form-control pr_field detail-input" name = "pin_address" style = "padding:10px;font-size:15px !important;">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control required_fields" name="entry-shopcode" id="entry-shopcode" >
                                                                <div class="note">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control required_fields" name="entry-shopurl" id="entry-shopurl"  onkeydown="return shopurlKeytrapped(event);">
                                                                <div class="note">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control required_fields" name="entry-shopname" id="entry-shopname" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <?php if(ini() == 'toktokmall'){   ?>
                                                                 ...
                                                                 <div class="form-group">
                                                                    <label for="entry-rate" class="control-label">Merchant Commission Rate <span class="red-asterisk">*</span></label>
                                                                       <div class="input-group-append">
                                                                            <input type="text" placeholder="0" class="form-control allownumericwithdecimal required_fields commcapping" name="entry-merchant-comrate" id="entry-merchant-comrate">
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                      <label for="f_rate" class="control-label">Startup</label> 
                                                                       <div class="input-group-append">
                                                                            <input type="text"  class="form-control allownumericwithdecimal required_fields" name="entry-f_startup" id="entry-f_startup" value="10">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                      <label for="f_jc" class="control-label">JC</label> 
                                                                       <div class="input-group-append">
                                                                           <input type="text" placeholder="1"  class="form-control allownumericwithdecimal required_fields" name="entry-f_jc" id="entry-f_jc" value="50">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                       ...
                                                                       <div class="input-group-append">
                                                                       <input type="text" placeholder="1" class="form-control allownumericwithdecimal required_fields" name="entry-f_mcjr" id="entry-f_mcjr"  value="60">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                      <label for="f_mc" class="control-label">MC</label> 
                                                                       <div class="input-group-append">
                                                                           <input type="text" placeholder="1" class="form-control allownumericwithdecimal required_fields" name="entry-f_mc" id="entry-f_mc"  value="70">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                      <label for="f_mcsuper" class="control-label">MCSUPER</label> 
                                                                       <div class="input-group-append">
                                                                            <input type="text"  placeholder="1"  class="form-control allownumericwithdecimal required_fields" name="entry-f_mcsuper" id="entry-f_mcsuper" value="80">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                     <label for="f_mcmega" class="control-label">MCMEGA</label> 
                                                                       <div class="input-group-append">
                                                                           <input type="text" placeholder="1" class="form-control allownumericwithdecimal required_fields" name="entry-f_mcmega" id="entry-f_mcmega" value="100">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6 col-md-6">
                                                                 <div class="form-group">
                                                                     <label for="f_others" class="control-label">Others</label> 
                                                                       <div class="input-group-append">
                                                                           <input type="text" placeholder="1" class="form-control allownumericwithdecimal required_fields" name="entry-f_others" id="entry-f_others" value="50">
                                                                            <span class="input-group-text">%</span>
                                                                        </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <?php    }else{    ?>
                                                                ...
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" placeholder="1.0" step="0.05" min="0" max="1" class="form-control required_fields" name="entry-rate" id="entry-rate" >
                                                                    </div>
                                                                </div>
                                                                <div class="col-12 col-lg-6">
                                                                    <div class="form-group">
                                                                        <label for="entry-rate" class="control-label">Commission Rate </label>
                                                                        <input type="number" step="0.01" min="0" class="form-control" name="entry-commrate" id="entry-commrate" >
                                                                    </div>
                                                                </div>
                                                            <?php    }    ?>
                                                ...
                                                <?php }else{ ?> <!-- UPDATING RECORD -->
                                                    <div class="form-group row">
                                                        <div class="col-12">
                                                           ...
                                                           <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control required_fields" name="entry-shopurl" id="entry-shopurl" value="<?= $sys_shop_details->shopurl ?>" onkeydown="return shopurlKeytrapped(event);">
                                                                <div class="note">
                                                                    Uppercase letter, numbers, space and underscore are allowed<br>Note: Space is converted to underscore after save
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="entry-shopname" class="control-label">Shop Name <span class="red-asterisk">*</span></label>
                                                                <input type="text" class="form-control required_fields" name="entry-shopname" id="entry-shopname" value="<?= $sys_shop_details->shopname ?>">
                                                            </div>
                                                        </div>
...
<div class="modal fade" id="show_whatsnew_merchant_modal" tabindex="-1" data-backdrop="static" data-keyboard="false"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header secondary-bg white-text d-flex align-items-center">
                <h3 class="modal-title" id="exampleModalLabel">Set What`s New Merchant</h3>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to set this in What`s New Merchant?</p>
                <br>
                <p>What`s New Merchants:</p>
                <ol class="list-group">

                <?php foreach ($get_whatsnew_merchant as $merchant): ?>
                    <li class="list-group-item"><?=$merchant['set_whatsnew_merchant_arrangement'];?>. <?=$merchant['shopname'];?></li>
                <?php endforeach ?>
         
                </ol>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-outline-secondary" id="uncheck_rabutton_whatsnew" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="check_rabutton_whatsnew" >Confirm</button>
            </div>
        </div>
    </div>
</div>
