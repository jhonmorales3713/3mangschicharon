									...
									<td style="padding: 20px 40px 0 40px">
											...
											<tbody>
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;"> Thank you for registering.</p>
													</td>
												</tr>
											</tbody>
										</table>
										<table style="width: 100%">
											<tbody>
												<tr>
													<td>
                                                        <p style="color: #F6841F; margin-bottom: 0; margin-top: 0;"><b>Username:</b><span style="color: #000;"> <?=$email;?></span></p>
                                        ...
                                        <table style="width: 100%">
											<tbody>
												<tr>
													<td>
                                                       <p style="color: #F6841F; margin-bottom: 0; margin-top: 0;">Please change your password upon log-in at <?=$resetpasslink;?></span></p>
		...
		<tbody>
			...
			<tr>
				<td colspan="3" width="100%">
                    ...
                    <!-- <p><br /> Thank you for registering. Here are the user details of your account:</p> -->
                    <p><br /> Thank you for registering.</p>
                    <p><br /> Username: <?=$email;?></p>
                    <!-- <p><br /> Your temporary password for the online access is <?=$password;?>. Please change your password upon log-in at <?=base_url();?></p> -->
                    <p><br /> Please change your password upon log-in at <?=$resetpasslink;?></p>
                    <p> </p>
				</td>
			</tr>
            <tr>
