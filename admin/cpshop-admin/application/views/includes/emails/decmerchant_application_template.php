							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$cn_first_name;?>!</h3>
									</td>
									...
									<td style="padding: 20px 40px 0 40px">
											...
											<tbody>
												<tr>
													<td>
														...
														<p style="margin-top: 0;">We regret to inform you that your registration has been denied.</p>
													</td>
												</tr>
											</tbody>
										</table>
										<table style="width: 100%">
											<tbody>
												<tr>
													<td>
													    <p style="margin-bottom: 0; margin-top: 0;"><b>We would like to thank you for taking the time to submit your registration. We encourage you to register again.</b></p>
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table style="width: 100%; background-color: #F8F8F8; border-radius: 10px; padding: 20px;">
											<tbody>
												<tr>
