                                        ...
                                        <table style="width: 100%">
											<tbody>
												<tr>
													<td>
                                                        <!-- <p style="color: #F6841F; margin-bottom: 0; margin-top: 0;"><b>Browser:</b><span style="color: #000;"> <?=$user_agent;?></span></p> -->
														<p style="color: #222; margin-top: 0;">If this was not an authorized login, please change your password.</p>
													</td>
												</tr>
											</tbody>
										</table>
		...
		<tbody>
			...
			<tr>
				<td colspan="3" width="100%">
                    ...
                    <label>Browser/Device: <?=$user_agent;?></label><br>
                    <label>-------------------------------</label><br>
                    <p><br /> If this was not an authorized login, please change your password.</p>
                    <p> </p>
				</td>
			</tr>
            <tr>
