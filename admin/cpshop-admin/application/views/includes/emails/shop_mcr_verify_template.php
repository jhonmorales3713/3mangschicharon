							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$data['verify_name']?>!</h3>
									</td>
												...
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">	
																This message is to notify you that the Merchant Commission Rate and Account Type Commission Rate of shop  
																<span  style="font-weight: 700;"><?=$data['shopname']?></span>  has been approved. <br>
				                                        </p>
													</td>
												</tr>
											</tbody>
											...
											<tbody>
												<tr>
													<td>
														<!-- <p style="color: #F6841F; margin-bottom: 0; margin-top: 0;"><b>Email Address</b></p> -->
														<p style="color: #222; margin-top: 0;">	
																Please verify to complete the process.
				                                        </p>
													</td>
												</tr>
											</tbody>
											...
											<tbody>
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">Kindly check and evaluate to proceed in verification process.</p>
													</td>
												</tr>
											</tbody>
										</table>
