		...
		<tbody>
			...
			<tr>
				<td colspan="3" width="100%">
					...
					<b>Dear <?= $transaction['name']; ?>,</b><p>
          				A package from your order #<?= $transaction['reference_num']; ?> has been successfully shipped. Please check you order details below. Thank you for shopping with us and hope to see you soon!</p>
				</td>
			</tr>
			<tr>
				<td colspan="4">
			...
			<tr>
				...
				<table class="order-status">
					<tbody>
						<tr>
							<td style="width: 100px; text-align: center"><img src="<?=get_s3_imgpath_upload().'assets/img/order-status/ready-for-pickup-done.png'?>" alt="" style="height: 40px;"></td>
							<td style="width: 100%; color: #222;"><strong>Ready for Pickup</strong></td>
						</tr>
					</tbody>
				</table>
						...
						<tr>
							...
							<td style="width: 100%;">
								<ul style="list-style-type: circle; padding-left: 0; margin-top: 0; vertical-align:top; margin-bottom: 40px">
									...
									<li style="list-style: none; font-size: 12px; color: gray">
									<?= date("M d, Y h:i a", strtotime($transaction['date_ready_pickup'])); ?>
									</li>
								</ul>
							</td>
						</tr>
				...
				<table class="order-status">
					<tbody>
						<tr>
							<td style="width: 100px; text-align: center"><img src="<?=get_s3_imgpath_upload().'assets/img/order-status/fulfilled-done.png'?>" alt="" style="height: 40px;"></td>
							<td style="width: 100%; color: #222;"><strong>Fulfilled</strong></td>
						</tr>
					</tbody>
				</table>
				...
				<table class="order-status">
					<tbody>
						<tr>
							...
							<td style="width: 100%;">
								<ul style="list-style-type: circle; padding-left: 0; margin-top: 0; vertical-align:top; margin-bottom: 40px">
									<?php if(!empty($transaction['pickedup_photo'])){?>
										<li style="list-style: none; color: #222">
										Item has been picked up and is now being delivered. [<a href="<?= $transaction['pickedup_photo']; ?>" target="_blank">View Image</a>]
										</li>
									<?php }else{?>
										<li style="list-style: none; color: #222">
									...
									<?php } ?>
									<li style="list-style: none; font-size: 12px; color: gray">
									<?= date("M d, Y h:i a", strtotime($transaction['date_fulfilled'])); ?>
									</li>
								</ul>
							</td>
						</tr>
				...
				<table class="order-status">
					<tbody>
						<tr>
							<td style="width: 100px; text-align: center"><img src="<?=get_s3_imgpath_upload().'assets/img/order-status/delivered-done.png'?>" alt="" style="height: 40px;"></td>
							<td style="width: 100%; color: #222;"><strong>Delivered</strong></td>
						</tr>
						<tr>
							<td colspan="2" style="width: 100%;">
								<ul style="list-style-type: circle; padding-left: 0; margin-top: 0; vertical-align:top; margin-bottom: 40px">
								<?php if(!empty($transaction['shipped_photo'])){?>
									<li style="list-style: none; color: #222">
										&nbsp;&nbsp;&nbsp;&nbsp;Order has been successfully shipped. [<a href="<?=$transaction['shipped_photo']?>" target="_blank">View Image</a>]
									</li>
								<?php }else{?>
									<li style="list-style: none; color: #222">
								...
								<?php }?>
									<li style="list-style: none; font-size: 12px; color: gray">
									&nbsp;&nbsp;&nbsp;&nbsp;<?= date("M d, Y h:i a", strtotime($transaction['shipped_date'])); ?>
									</li>
								</ul>
							</td>
						</tr>
				...
				<td colspan="4">
					<table border='0'>
						<tbody>
							...
							<?php if($transaction['shipping_ref'] != '') { ?>
	              				<tr>
									<td>Shipping</td>
									<td>&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
									<td ><?= $transaction['shipping_ref'] ?> (via <?= $transaction['shippingpartner'] ?>)</td>
	              				</tr>
	              			<?php } else { ?>
	              				<tr>
									<td>Shipping</td>
	              			...
	              			<?php } ?>
							<?php if(!empty($transaction['rider_name'])){?>
								<tr>
									<td>Rider Details</td>
									<td>&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;</td>
									<td ><?= $transaction['rider_name'] ?> (<?= $transaction['rider_platenum'] ?> - <?= $transaction['rider_conno'] ?>)</td>
								</tr>
							<?php }?>
							<tr>
