							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$fname;?> <?=$lname;?>!</h3>
									</td>
											...
											<tbody>
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">We are thrilled to inform you that access to your account has been granted! You may now log in using the email address and password that you have set.</p>
													</td>
												</tr>
											</tbody>
										</table>
