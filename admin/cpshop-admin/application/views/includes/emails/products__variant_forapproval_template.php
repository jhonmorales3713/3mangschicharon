							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$data['approval_name']?>!</h3>
									</td>
												...
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">
													     	This message is to notify you that the Merchant Commission Rate and Account Type Commission Rate of the item  
														     <span  style="font-weight: 700;"><?=$data['variant_name']?></span>  is under your approval. <br>
															</p>
													</td>
												</tr>
											</tbody>
