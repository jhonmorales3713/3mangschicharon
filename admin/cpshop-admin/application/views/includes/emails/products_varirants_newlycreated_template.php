							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$data['new_product_name'];?>!</h3>
									</td>
												...
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">
																This message is to notify you that <span style="font-weight: 700;"><?=$data['shopname'];?> </span> 
																 added a new variant <span  style="font-weight: 700;"><?=$data['variant_name']?></span>
																  for product <span  style="font-weight: 700;"><?=$data['itemname']?></span> <br>
					       								</p>
													</td>
												</tr>
											</tbody>
										...
										<table style="width: 100%">
											<tbody>
												<tr>
													<td>
														<!-- <p style="color: #F6841F; margin-bottom: 0; margin-top: 0;"><b>Email Address</b></p> -->
														<p style="color: #222; margin-top: 0;">Kindly set the admin settings by generating the Item ID and encoding the Merchant Commission Rate  for this item.</p>
													</td>
												</tr>
											</tbody>
										</table>
