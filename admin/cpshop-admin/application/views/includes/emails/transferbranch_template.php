		...
		<tbody>
			...
			<tr>
				<td colspan="3" width="100%">
					<br/>
					<b>Dear <?= $transaction['branchname']; ?>,</b><p>
          				Good day! Order #<?= $transaction['reference_num']; ?> has been transfered to your branch. Please check your portal for other information.</p>
				</td>
			</tr>
			<tr>
				<td colspan="4">
			...
			<tr>
				<td colspan="4">
                    ...
                    <?php $packageCnt = 1;
						...
						<?php $total_amount_conv = 0; 
							  $subtotal = 0; 
						foreach($shops['items'] as $items){  ?>
                    		<tr>
                    			<td></td>
                    			<td width="10%">
