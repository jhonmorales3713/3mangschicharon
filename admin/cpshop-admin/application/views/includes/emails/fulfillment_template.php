			...
			<tr>
				<td colspan="3" width="100%">
					...
					<b>Dear <?= $transaction['name']; ?>,</b><p>
          				Your item is being delivered. Our rider will deliver your order #<?= $transaction['reference_num']; ?> today. Please check your delivery and order details below.</p>
				</td>
			</tr>
			<tr>
				<td colspan="4">
