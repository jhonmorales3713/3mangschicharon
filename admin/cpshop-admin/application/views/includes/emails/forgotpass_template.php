							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$userObj->fname;?>!</h3>
									</td>
											...
											<tbody>
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">Someone has requested a password reset for account <?=$userObj->username;?>.</p>
													</td>
												</tr>
											</tbody>
										</table>
