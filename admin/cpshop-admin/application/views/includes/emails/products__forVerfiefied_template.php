							...
							<tbody>
								<tr style="height: 100px; border: 0">
									<td style="padding: 40px 0px 0 40px">
										<h3 style="color:#F6841F; margin-top: 0;  width: 70%; font-size: 18px">Good day, ka-toktok <?=$data['verified_name']?>!</h3>
									</td>
												...
												<tr>
													<td>
														...
														<p style="color: #222; margin-top: 0;">
																   ...
																   <span  style="font-weight: 700;"><?=$data['itemname']?></span>  has been approved. <br>
														</p>
													</td>
												</tr>
											</tbody>
										...
										<table style="width: 100%">
											<tbody>
												<tr>
													<td>
														<!-- <p style="color: #F6841F; margin-bottom: 0; margin-top: 0;"><b>Email Address</b></p> -->
														<p style="color: #222; margin-top: 0;">Please verify to complete the process and enable this item.</p>
													</td>
												</tr>
											</tbody>
										</table>
