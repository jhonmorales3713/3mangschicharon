						...
						<div class="row">
							<div class="col-md-6 col-lg-3">
								<div class="form-group">
									...
									<input type="text" name="_username" class="form-control material_josh form-control-sm search-input-text url enter_search" placeholder="Username">
								</div>
							</div>
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-md-auto px-1 mb-3">
								<?php if ($this->loginstate->get_access()['users']['create']== 1): ?>
									...
									<button class="btn-mobile-w-100 mx-0 mx-sm-2 btn btn-primary d-flex align-items-center justify-content-center btn-block mb-3" id="addBtn">Add</button>
								<?php endif ?>
                            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/settings/settings_user_list.js');?>"></script>
