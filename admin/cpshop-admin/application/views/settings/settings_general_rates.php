    ...
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <?php if($sys_shop == 0){?>
                ...
                <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Settings_shipping_delivery/general_list/'.$token);?>">Shipping and Delivery - Shop List</a></li>
                <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <?php }else{ ?>
                <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Settings_shipping_delivery/shipping_delivery/'.$token);?>">Shipping and Delivery</a></li>
                <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            ...
            <li class="breadcrumb-item active">General Shipping Rates</li>
        </ol>
    </div>


<?php 
    $shipping_access_create = $this->loginstate->get_access()['general_shipping']['create'];
    $shipping_access_update = $this->loginstate->get_access()['general_shipping']['update'];
    $shipping_access_delete = $this->loginstate->get_access()['general_shipping']['delete'];
?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <small>All products not in other profiles</small>
                </div>
                <div class="card-body">

                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-bordered table-grid display nowrap" id="table-grid_products">
                            <thead>
                                <tr>
                                    <th width="50"></th>
                                    <th>Item Name</th>
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php }?>
                    <br><br><br><br><br>
                    <div id="zoneDiv" class="table-responsive" >
...
<?php if($this->loginstate->get_access()['general_shipping']['update'] == 1 || $this->loginstate->get_access()['general_shipping']['create'] == 1){ ?>
    <div class="col-lg-12">&nbsp;</div>
    <div class="footer">
                ...
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-6 daysshipdiv">
                            <div class="form-group">
                                <label for="from_day" class="control-label">From <br> <span class="text-xs md-text-base">(Days to Ship)</span></label>
                                <input type="number" class="form-control allownumericwithdecimal" name="from_day" id="from_day" value="0">
                            </div>
                        </div>
                        <div class="col-6 daysshipdiv">
                            <div class="form-group">
                                <label for="to_day" class="control-label">To <br> <span class="text-xs md-text-base">(Days to Ship)</span></label>
...
<script type="text/javascript" src="<?=base_url('assets/js/settings/settings_general_rates.js');?>"></script>
