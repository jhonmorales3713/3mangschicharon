...
<div class="py-4">
	<div class="form-group col-12 super_parent_section">
		...
		<div class="form-group parent_section mt-3">
			<h3 class="font-weight-bold">Online Ordering</h3>
			<div class="row mb-1">
		...
		<div class="">
			<div class="nav nav-tabs p-0" id="v-pills-tab">
				<a class="nav-link active" id="v-pills-dashboard-tab" data-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="true">Dashboard <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-order-headers-tab" data-toggle="pill" href="#v-pills-order-headers" role="tab" aria-controls="v-pills-order-headers" aria-selected="false" class="row m-0">Orders <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-products-tab" data-toggle="pill" href="#v-pills-products" role="tab" aria-controls="v-pills-products" aria-selected="false">Products <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-shops-tab" data-toggle="pill" href="#v-pills-shops" role="tab" aria-controls="v-pills-shops" aria-selected="false">Shops <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-customers-tab" data-toggle="pill" href="#v-pills-customers" role="tab" aria-controls="v-pills-customers" aria-selected="false">Customers <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-accounts-tab" data-toggle="pill" href="#v-pills-accounts" role="tab" aria-controls="v-pills-accounts" aria-selected="false">Accounts <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-reports-tab" data-toggle="pill" href="#v-pills-reports" role="tab" aria-controls="v-pills-reports" aria-selected="false">Reports <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">Settings <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-vouchers-tab" data-toggle="pill" href="#v-pills-vouchers" role="tab" aria-controls="v-pills-vouchers" aria-selected="false">Vouchers <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-wallet-tab" data-toggle="pill" href="#v-pills-wallet" role="tab" aria-controls="v-pills-wallet" aria-selected="false">Wallet <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-support-tab" data-toggle="pill" href="#v-pills-support" role="tab" aria-controls="v-pills-support" aria-selected="false">Support <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-promotion-tab" data-toggle="pill" href="#v-pills-promotion" role="tab" aria-controls="v-pills-promotion" aria-selected="false">Promotion <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
				<a class="nav-link" id="v-pills-dev_settings-tab" data-toggle="pill" href="#v-pills-dev_settings" role="tab" aria-controls="v-pills-dev_settings" aria-selected="false">Developer Settings <span class="check-count text-xs rounded-lg px-1 bg-teal-500 text-light">0</span></a>
			</div>
			<div class="tab-content" id="v-pills-tabContent">
				...
				<div class="tab-pane fade w-100 online_ordering parent_section has-seller-access has-seller-branch-access has-food-hub-access" id="v-pills-order-headers" role="tabpanel" aria-labelledby="v-pills-order-headers-tab">
					<div class="py-3 px-4 row m-0 mb-1">
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Order List</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
								...
								<?php if(ini() == 'toktokmart'){ ?>
									<div class="col-6 col-sm-3">
										<label>
											<input type="checkbox" name="ac_modify" class="ac_modify checkbox-template m-r-xs mr-2 order_list_ac_fxns">
											Modify Orders
										</label>
									</div>
								<?php } ?>
				...
				<div class="tab-pane fade w-100 online_ordering parent_section has-seller-access" id="v-pills-products" role="tabpanel" aria-labelledby="v-pills-messages-tab">
					<div class="py-3 px-4 row m-0 mb-1">
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Products waiting for approval</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Products for Approve</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Products for Decline</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Products Verify </h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
				...
				<div class="tab-pane fade w-100 online_ordering parent_section" id="v-pills-shops" role="tabpanel" aria-labelledby="v-pills-shops-tab">
					...
					<div class="col-12 mt-2">
							<h4 class="font-semibold">Shop MCR Scheduling</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="shop_mcr_sch_view" name="shop_mcr_sch_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="shop_mcr_sch_view_shop" name="shop_mcr_sch_view_shop" class="checkbox-template m-r-xs mr-2">
										View Shop
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="shop_mcr_sch_delete" name="shop_mcr_sch_delete" class="checkbox-template m-r-xs mr-2">
										Delete
									</label>
								</div>
							</div>
					...
					<div class="col-12 mt-2 with_sub_parent_section">
						<h4 class="font-semibold">Shop Mcr Approval</h4>
					    	<div class="col-6 col-sm-3">
								<label>
									<input type="checkbox" id="shop_mcr_view" name="shop_mcr_view" class="checkbox-template m-r-xs mr-2">
									View
								</label>
							</div>
							<div class="py-3 px-4 row m-0 mb-1">
							<div class="col-12 mt-2">
								<h4 class="font-semibold">Access View</h4>
								<div class="row">
									<div class="col-6 col-sm-3">
										<label>
											<input type="checkbox" id="shop_mcr_wfa_view" name="shop_mcr_wfa_view" class="checkbox-template m-r-xs mr-2">
											Waiting for Approval View
										</label>
									</div>
									<div class="col-6 col-sm-3">
										<label>
											<input type="checkbox" id="shop_mcr_approve_view" name="shop_mcr_approve_view" class="checkbox-template m-r-xs mr-2">
											Approved View
										</label>
									</div>
									<div class="col-6 col-sm-3">
										<label>
											<input type="checkbox" id="shop_mcr_decline_view" name="shop_mcr_decline_view" class="checkbox-template m-r-xs mr-2">
											Declined View
										</label>
									</div>
									<div class="col-6 col-sm-3">
										<label>
											<input type="checkbox" id="shop_mcr_verified_view" name="shop_mcr_verified_view" class="checkbox-template m-r-xs mr-2">
											Verified View
										</label>
									</div>
								</div>
						    ...
						    <div class="col-12 mt-2">
								<h4 class="font-semibold">Access Button</h4>
									<div class="row">
										<div class="col-6 col-sm-3">
												<label>
													<input type="checkbox" id="shop_mcr_approve" name="shop_mcr_approve" class="checkbox-template m-r-xs mr-2">
													Approved
												</label>
										</div>
										<div class="col-6 col-sm-3">
												<label>
													<input type="checkbox" id="shop_mcr_verify" name="shop_mcr_verify" class="checkbox-template m-r-xs mr-2">
													Verify
												</label>
										</div>
										<div class="col-6 col-sm-3">
												<label>
													<input type="checkbox" id="shop_mcr_decline" name="shop_mcr_decline" class="checkbox-template m-r-xs mr-2">
												Decline
												</label>
										</div>
										<div class="col-6 col-sm-3">
												<label>
													<input type="checkbox" id="shop_mcr_edit" name="shop_mcr_edit" class="checkbox-template m-r-xs mr-2">
													Edit
												</label>
										</div>
									</div>
				...
				<div class="tab-pane fade w-100 parent_section" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
					<div class="py-3 px-4 row m-0 mb-1">
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Products Main Category</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
						...
						<div id="void-record" class="col-12 mt-2"><!-- 080220 -->
						...
						<div id="void-record-list" class="col-12 mt-2"><!-- 080220 -->
						...
						<div id="shop-popup" class="col-12 mt-2">
							<h4 class="font-semibold">Shop Pop up image</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="shop_popup_view" name="shop_popup_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="shop_popup_create" name="shop_popup_create" class="checkbox-template m-r-xs mr-2">
										Create
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="shop_popup_update" name="shop_popup_update" class="checkbox-template m-r-xs mr-2">
										Update
									</label>
								</div>
							</div>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Faqs CMS</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="faqs_view" name="faqs_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="faqs_create" name="faqs_create" class="checkbox-template m-r-xs mr-2">
										Create
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="faqs_update" name="faqs_update" class="checkbox-template m-r-xs mr-2">
										Update
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="faqs_disable" name="faqs_disable" class="checkbox-template m-r-xs mr-2">
										Disable
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="faqs_delete" name="faqs_delete" class="checkbox-template m-r-xs mr-2">
										Delete
									</label>
								</div>
							</div>
				...
				<div class="tab-pane fade w-100 online_ordering parent_section" id="v-pills-vouchers" role="tabpanel" aria-labelledby="v-pills-vouchers-tab">
					<div class="py-3 px-4 row m-0 mb-1">
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Reclaimed Vouchers List</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="ac_reclaimed_vouchers_list_view" name="ac_reclaimed_vouchers_list_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
							</div>
				...
				<div class="tab-pane fade w-100 parent_section" id="v-pills-promotion" role="tabpanel" aria-labelledby="v-pills-promotion-tab">
					<div class="py-3 px-4 row m-0 mb-1">
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Piso Day</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Discount Promo</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_mystery_coupon_view" name="pr_mystery_coupon_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_mystery_coupon_create" name="pr_mystery_coupon_create" class="checkbox-template m-r-xs mr-2">
										Create
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_mystery_coupon_update" name="pr_mystery_coupon_update" class="checkbox-template m-r-xs mr-2">
										Update
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_mystery_coupon_approve" name="pr_mystery_coupon_approve" class="checkbox-template m-r-xs mr-2">
										Approve
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_mystery_coupon_disable" name="pr_mystery_coupon_disable" class="checkbox-template m-r-xs mr-2">
										Disable
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_mystery_coupon_delete" name="pr_mystery_coupon_delete" class="checkbox-template m-r-xs mr-2">
										Delete
									</label>
								</div>
							</div>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Shipping Fee Discount</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_sfd_view" name="pr_sfd_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_sfd_create" name="pr_sfd_create" class="checkbox-template m-r-xs mr-2">
										Create
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_sfd_update" name="pr_sfd_update" class="checkbox-template m-r-xs mr-2">
										Update
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_sfd_delete" name="pr_sfd_delete" class="checkbox-template m-r-xs mr-2">
										Delete
									</label>
								</div>
							</div>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Campaign Type</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_campaign_type_view" name="pr_campaign_type_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_campaign_type_create" name="pr_campaign_type_create" class="checkbox-template m-r-xs mr-2">
										Create
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_campaign_type_update" name="pr_campaign_type_update" class="checkbox-template m-r-xs mr-2">
										Update
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="pr_campaign_type_delete" name="pr_campaign_type_delete" class="checkbox-template m-r-xs mr-2">
										Delete
									</label>
								</div>
							</div>
						...
						<div class="col-12 mt-2">
							<h4 class="font-semibold">Voucher Discounts</h4>
							<div class="row">
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="voucher_discount_view" name="voucher_discount_view" class="checkbox-template m-r-xs mr-2">
										View
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="voucher_discount_create" name="voucher_discount_create" class="checkbox-template m-r-xs mr-2">
										Create
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="voucher_discount_update" name="voucher_discount_update" class="checkbox-template m-r-xs mr-2">
										Update
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="voucher_discount_disable" name="voucher_discount_disable" class="checkbox-template m-r-xs mr-2">
										Disable
									</label>
								</div>
								<div class="col-6 col-sm-3">
									<label>
										<input type="checkbox" id="voucher_discount_delete" name="voucher_discount_delete" class="checkbox-template m-r-xs mr-2">
										Delete
									</label>
								</div>
							</div>
