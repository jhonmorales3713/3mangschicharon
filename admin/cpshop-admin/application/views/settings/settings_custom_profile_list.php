                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">Profile List</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                <!-- <label class="form-control-label col-form-label-sm">Profile Name</label> -->
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-md-auto px-1">
                                <?php if($this->loginstate->get_access()['custom_shipping']['update'] == 1 || $this->loginstate->get_access()['custom_shipping']['create'] == 1){ ?>
                                        <button class="btn-mobile-w-100 mx-0 mx-sm-2 btn btn-outline-primary mb-3 mb-md-0" id="addBtn">Add</button>
                                <?php } ?>
                            </div>
...
<input type="hidden" class="hidden" id="shipping_id" value="<?=$shipping_id?>">

<!-- start - load the footer here and some specific js -->
<?php $this->load->view('includes/footer');?> <!-- includes your footer -->
<script type="text/javascript" src="<?=base_url('assets/js/settings/settings_custom_profile_list.js');?>"></script>
