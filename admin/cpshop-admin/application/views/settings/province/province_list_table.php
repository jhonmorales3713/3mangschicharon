                ...
                <div class="px-4 pt-3 pb-3 pb-md-0" id="card-header_search" data-show="1">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <!-- <label class="form-control-label col-form-label-sm">Search By</label> -->
                            <select class="form-control" id="_searchby" name="_searchby">
                                <option value="province" selected>Province</option>
                                <option value="region">Region</option>
                            </select>
                        </div>
                        <div class="col-md-6 col-lg-3" id="_provcode">
                            <div class="form-group">
                                <!-- <label class="form-control-label col-form-label-sm">Province Code</label> -->
                                <input type="text" name="_code" class="form-control material_josh form-control-sm search-input-text url enter_search" placeholder="Province Code">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                    ...
                    <div class="col-md-8 col-lg-auto table-search-container text-right">
                        <div class="row no-gutters">
                            <div class="col-12 col-md-auto">
                                <div class="row no-gutters">
                                    <form action="<?=base_url('settings/Settings_province/export_province_list')?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets/js/settings/province/province.js');?>"></script>
