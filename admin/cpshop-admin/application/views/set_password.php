                    ...
                    <div class="row">
                        <div class="col-12 pt-5 pl-5 pr-5 pb-4">
                            ...
                            <div class="my-5">
                                ...
                                <p class="login-page-subtitle">Hi <?=$email;?>, please set your new password.</p>
                            </div>
                            <form method="post" action="" id="setpassword-form">
                                <div class="form-group">
                                    <label for="login-password" class="input-label">Password</label><i class="bar"></i>
                                    <div class="w-100 form-control-password">
                                        <input type="hidden" name="loginUsername" value="<?=$email;?>">
                                ...
                                <div class="form-group">
                                    <label for="login-password" class="input-label">Confirm Password</label><i class="bar"></i>
                                    <div class="w-100 form-control-password">
                                        <input type="password" class="form-control" name="loginPassword2" id="login-password_2" required="required" placeholder="Confirm your password here...">
                                        <i class="fa fa-eye-slash password-icon password-show" aria-hidden="true"></i>
                                        <i class="fa fa-eye password-icon password-hide" aria-hidden="true"></i>
                                    </div>
                                </div>
                                ...
                                <div class="form-group text-center mb-5 justify-content-center">
                                    <button type="submit" class="btn btn-primary-cp py-1 px-4" id="btnSave">Save</button>
                                </div>
                            </form>
