...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Accounts">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Billing (By Payment Portal Fee)</li>
        </ol>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">Billing (By Payment Portal Fee)</h3>
                        </div>
    ...
    <div id="modal_save" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="billingform" enctype="multipart/form-data" method="post" action="">
                <div class="modal-header">
                    <div class="col-md-12">
                        <!-- <h4 id="tm_header_ref" class="modal-title"></h4> -->
                        <h4 id="exampleModalLabel" class="modal-title">Billing</h4>
                    </div>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4">
                                <label class="">Payment Portal Fee</label>
                            </div>
                            <div class="col-12 col-sm-8">
...
<script type="text/javascript" src="<?=base_url('assets\js\accounts\billing_government.js');?>"></script>
