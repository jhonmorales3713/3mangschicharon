...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Accounts" data-access = "<?=en_dec('en',$this->loginstate->get_access()['billing']['admin_view'])?>" data-ini = "<?=en_dec('en',ini())?>">
                  ...
                  <div class="col-12">
                          ...
                          <table class="table table-striped table-inverse table-responsive">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-50"><label class="text-xs md:text-base" id="tm_totalamount" class="green-text"></label></td>
                                    </tr>
                                    <tr>
                                        <td class="w-50"><label class="text-xs md:text-base">Delivery Amount</label></td>
                                        <td class="w-50"><label class="text-xs md:text-base" id="tm_delivery_amount" class="green-text"></label></td>
                                    </tr>
                                    <tr>
                                        <td class="w-50"><label class="text-xs md:text-base">Total Amount w/ Delivery Amount</label></td>
                                        <td class="w-50"><label class="text-xs md:text-base" id="tm_totalamount_w_shipping" class="green-text"></label></td>
                                    </tr>
                                    <tr>
                      ...
                      <div class="row grp_payment" id="grp_payment">
                          <table class="table table-striped table-inverse table-responsive">
                                <tbody>
                                    <tr>
                                        <td class="w-50"><label class="text-xs md:text-base">Deposit Date</label></td>
                                        <td class="w-50"><label class="text-xs md:text-base" id="tm_depositdate"></label></td>
                                    </tr>
                                    <tr>
                ...
                <thead>
                  <?php if(ini() == "toktokmall"):?>
                    <tr>
                        ...
                        <th>Refcom</th>
                        <th>Process Fee</th>
                        <th>Total Amount w/o Delivery fee</th>
                    </tr>
                  <?php else:?>
                    <tr>
                        <th>Product Name</th>
    ...
    <div class="modal fade" id = "manual_cron_modal" >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title text-dark">Trigger Cron Manully</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <div class="modal-body">
            <div class="form-group row">
              <div class="col-12 mb-3">
                <input type="hidden" class="form-control" id = "key" name = "key" value = "ShopandaKeyCloud3578">
              </div>
              <div class="col-12">
                <input type="date" class="form-control" id = "cron_date" name = "cron_date">
              </div>
            </div>
          </div>
          <div class="modal-footer text-right">
            <button class="btn btn-sm btn-primary" id = "btn_trigger_cron">Save</button>
            <button class="btn blue-grey" data-dismiss = "modal">Close</button>
          </div>
        </div>
      </div>
...
<script type="text/javascript" src="<?=base_url('assets\js\accounts\billing.js');?>"></script>
