...
<div class="content-inner" id="pageActive" data-num="9" data-namecollapse="" data-labelname="Developer Settings">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php foreach($cn2 as $cn2){ ?>
                <?php //if ($this->session->userdata('username') == 'paulchua@cloudpanda.ph') { 
                if (in_array($cn2->id, $arr_)) {  ?>
                    <?php $counter2++; ?> 
