...
<div class="content-inner" id="pageActive" data-num="3" data-namecollapse="" data-labelname="Products"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_products/update_products/'.$token.'/'.$parent_Id);?>"><?=$get_parentProduct['itemname']?></a></li>
            <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 nostocksdiv" id="nostocksdiv2">
                                        <div class="form-group divnostock" id="div_no_of_stocks_0">
                                            ...
                                            <input type="number" class="form-control" name="f_no_of_stocks_0" id="f_no_of_stocks_0" placeholder="Number of stocks" value="0">
                                        </div>
                                    </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/products/add_variant.js');?>"></script>
