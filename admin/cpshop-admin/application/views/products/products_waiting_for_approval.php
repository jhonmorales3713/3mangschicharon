                ...
                <div class="card-header py-2">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            Product Waiting for Approval List
                        </div>
                ...
                <br>
                    <div class="row no-gutters  pull-right">
                        ...
                        <?php if($validation['approved'] == 1){ ?>
                            <button class="btn btn-success ApproveAll" type="button" id="ApproveAll">Batch Approve</button>
                            <?php } ?>
                        </div>
                        <div class="col-6 col-md-auto px-1 mb-3">
...
<input type="hidden" id="access_edit" value="<?= $validation['edit'] ?>">
...
<script type="text/javascript" src="<?= base_url('assets/js/products/products_approval.js'); ?>"></script>
