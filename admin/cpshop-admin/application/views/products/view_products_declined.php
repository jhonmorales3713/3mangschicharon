        ...
        <div class="row">
            <div class="col">
                <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
                    ...
                    <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_products/products_declined/'.$token);?>">Products Decline List</a></li>
                    <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- <?php if($validation['approved'] == 1){ ?>
                            <button type="button" class="btn btn-success" id="ApproveButton" data-toggle="modal" data-target="#approveModal" style="color: #fff;">Update</button>
                        <?php } ?> -->
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/products/view_products_declined.js');?>"></script>
