        ...
        <div class="row">
            <div class="col">
                <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
                    ...
                    <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_products/view_products_approved/'.$token);?>">Product Approved List</a></li>
                    <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if($validation['approved'] == 1){ ?>
                            <button type="button" class="btn btn-success" id="ApproveButton" data-toggle="modal" data-target="#approveModal" style="color: #fff;">Verify</button>
                        <?php } ?>
    ...
    <div role="document" class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <div class="col-md-12">
                    <h4 id="tm_header_ref" class="modal-title" style="color:black;">Verify</h4>
                </div>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <b>Are you sure?</b><br>
                        <label class="">Products changes will be successfully verified.</label>
                    </div>
                </div>
            </div>
            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/products/view_products_approved.js');?>"></script>
