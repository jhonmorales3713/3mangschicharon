                                            ...
                                            <?php if($branchid == 0){?>
                                                ...
                                                <?php if($get_branchdetails != false){?>
                                                    <?php foreach($get_branchdetails as $row){?>
                                                        ...
                                                        <?php $hidden_input_name = 'hidden_f_no_of_stocks_'.$row['id']; ?>
                                ...
                                <div class="row">
                                    ...
                                    <?php if($this->loginstate->get_access()['products']['create'] == 1){ ?>
                                        <div class="col-3 parentVariantDiv">
                                            <a href="<?=base_url('Main_products/add_variant/'.$token.'/'.$Id)?>" class="btn btn-primary">Add variant</a>
                                        </div>
                                    <?php } ?>
                                                ...
                                                <tr class="variant_tr_<?=$row['Id']?>">
                                                    ...
                                                    <td style="width:25%;"class="td-center variant_tr_<?=$row['Id']?>">
                                                        <?php if($this->loginstate->get_access()['products']['update'] == 1){ ?>
                                                            <a  href="<?=base_url('Main_products/update_variants/'.$token.'/'.$row['Id'].'/'.$Id);?>" class='btn btn-primary' data-value='<?=$row['Id']?>'><i class='fa fa-pencil'></i></a>&nbsp;
                                                        <?php }?>
...
<script type="text/javascript" src="<?=base_url('assets/js/products/update_products.js');?>"></script>
