        ...
        <div class="row">
            <div class="col">
                <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
                    ...
                    <li class="breadcrumb-item"><a class="white-text" href="<?=base_url('Main_products/products_waiting_for_approval/'.$token);?>">Product waiting for approval List</a></li>
                    <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php if($validation['approved'] == 1){ ?>
                            <button type="button" class="btn btn-success" id="ApproveButton" data-toggle="modal" data-target="#approveModal" style="color: #fff;">Approve</button>
                        <?php } ?>
                        <?php if($validation['declined'] == 1){ ?>
                             <button type="button" class="btn btn-danger" id="DeclineButton" data-toggle="modal" data-target="#declineModal" style="color: #fff;">Decline</button>
                        <?php } ?>
                        <?php if($validation['edit'] == 1){ ?>

                             <?php if($get_productdetails['parent_product_id'] != null && $get_productdetails['parent_product_id']  != 0){ ?>
                                     <a href="<?=base_url('Main_products/update_variants/'.$token.'/'.$get_productdetails['Id'].'/'.$get_productdetails['parent_product_id'])?>"  class="btn btn-primary" style="color: #fff;">Edit</a>
                            <?php }else{ ?>
                                    <a href="<?=base_url('Main_products/update_products/'.$token.'/'.$get_productdetails['Id'])?>"  class="btn btn-primary" style="color: #fff;">Edit</a>
                             <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-12 text-right">
                    ...
                    <button type="button" id="proceedBtn" class="btn btn-success waves-effect waves-light" aria-label="Close" data-prod-id="<?=$Id?>">Proceed</button>
                </div>
            </div>
        </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-12 text-right">
                    ...
                    <button type="button" id="proceedDecBtn" class="btn btn-success waves-effect waves-light" aria-label="Close" data-prod-id="<?=$Id?>">Proceed</button>
                </div>
            </div>
        </form>
        </div>
...
<input type="hidden" id="access_declined" value="<?= $validation['declined'] ?>">

<input type="hidden" name="branchid" id="branchid" value="<?=$branchid?>">
<!-- start - load the footer here and some specific js -->
<?php $this->load->view('includes/footer');?> <!-- includes your footer -->
<script type="text/javascript" src="<?=base_url('assets/js/products/view_products_approval.js');?>"></script>
