                    ...
                    <div class="row no-gutters  pull-right">
                        <div class="col-6 col-md-auto px-1 mb-3">
                           <?php if($validation['approved'] == 1){ ?>
                              <button class="btn btn-success ApproveAll" type="button" id="ApproveAll"> Batch Verify</button>
                            <?php } ?>
                        </div>
                        <div class="col-6 col-md-auto px-1 mb-3">
                        <?php if($validation['declined'] == 1){ ?>
                            <button class="btn btn-danger DeclineALL" type="button" id="DeclineALL">Batch Decline</button>
                        <?php } ?>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/products/products_approved.js');?>"></script>
