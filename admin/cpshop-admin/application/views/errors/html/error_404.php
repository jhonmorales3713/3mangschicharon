...
<link rel="shortcut icon" type="image/png" href="<?=base_url('assets/img/PandaBooks-ico.png'); ?>"/>
<style type="text/css">
	...
	<div class="container">
		<div class="row">
			<div class="offset-lg-2 col-lg-8 col-12 text-center my-auto">
				<img src="<?php echo base_url("assets/img/panda-error.png") ?>" alt="" class="mb-4 w-75">
