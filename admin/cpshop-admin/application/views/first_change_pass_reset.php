...
<head>
	...
	<title><?=get_company_name();?> | Reset Password</title>
...
<link rel="stylesheet" type="text/css" href="<?=base_url('assets/css/first_change_pass_reset.css'); ?>">
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600;700&display=swap" rel="stylesheet">
<?php 
    switch (ini()) {
        case 'jcww':
						...
						<div class="row">
							<div class="col-12 pt-5 pl-5 pr-5 pb-4">
								...
								<div class="my-5">
									...
									<p class="login-page-subtitle">Please enter and confirm your new password below to access your account.
								...
								<form class="mt-4 mb-5" id="saveChangePassForm">
                                    <input type="hidden" name="user-id" value="<?= $sys_users_id ?>">
									<div class="form-group mb-4"> 
                                        <label for="newpass-for-pass">New Password </label> 
										<div class="w-100 form-control-password newPassword ">
                                    ...
                                    <div class="form-group mb-4"> 
                                        <label for="newpass-for-pass">Re-type New Password </label> 
										<div class="w-100 form-control-password retypePassword ">
											...
											<i class="fa fa-eye-slash retypepassword-icon retypepassword-show" aria-hidden="true"></i>
											<i class="fa fa-eye retypepassword-icon retypepassword-hide" aria-hidden="true"></i>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-12 mb-2">
                                            <button disabled style="float:right" class="btn btn-primary-cp saveChangePassBtn">Save</button>
											</div>
										</div>
									</div>
								</form>
...
<!---->
<script src="<?=base_url('assets/js/first_change_pass_reset.js');?>"></script>
...
$(".password-icon").click(function(){
	$(".newPassword").toggleClass("form-control-password--show");
});

$(".password-show").click(function(){
	document.getElementById('sec-newpass').type = 'text'; 
})

$(".password-hide").click(function(){
	document.getElementById('sec-newpass').type = 'password';

}) 

$(".retypepassword-icon").click(function(){ 
	$(".retypePassword").toggleClass("form-control-password--show");
});
 
$(".retypepassword-show").click(function(){ 
	document.getElementById('sec-retypenewpass').type = 'text'; 
})

$(".retypepassword-hide").click(function(){ 
	document.getElementById('sec-retypenewpass').type = 'password'; 
})
