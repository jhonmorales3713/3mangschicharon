                    ...
                    <div class="row">
                        <div class="col-12 pt-5 pl-5 pr-5 pb-4">
                            ...
                            <div class="my-5">
                                ...
                                <p class="login-page-subtitle">Hi <?=$email;?>, please enter your code that we've sent to your email.</p>
                            </div>
                            <form method="post" action="" id="setcode-form">
                                <div class="form-group">
                                    <label for="login-password" class="input-label">Code</label><i class="bar"></i>
                                    <div class="w-100 form-control-password">
                                        <input type="hidden" name="loginUsername" id="loginUsername" value="<?=$email;?>">
                                        <input type="text" class="form-control" name="loginCode" id="loginCode" required="required" placeholder="Type your code here...">
                                     </div>
                                </div>
                                ...
                                <div class="form-group text-right">
                                    <a href="#" id="resendAccessCode">Resend Code</a>
                                </div>
                                <br>
                                <div class="form-group text-center mb-5 justify-content-center">
                                    <button type="submit" class="btn btn-primary-cp py-1 px-4" id="btnSave">Enter</button>
                                </div>
                            </form>
