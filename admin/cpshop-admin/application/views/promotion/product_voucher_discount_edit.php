...
<div class="content-inner" id="pageActive" data-num="" data-namecollapse="" data-labelname="Add Voucher"> 
    <div class="bc-icons-2 card mb-4">
       <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <li class="breadcrumb-item active">Edit Voucher Discount</li>
        </ol>
    </div>
                    ...
                    <div class="card">
                        ...
                        <form id="save_voucher" enctype="multipart/form-data" method="post">
                            <div class="card-body center">
                              <input type="hidden" id="vouchers_id" name="vouchers_id" value="<?= $id ?>">
                               ...
                               <div class="row">
                                        <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <?php  if($voucher_details->voucher_type == 2){?>
                                                           <input type="radio" id="product_voucher_type" name="voucher_type"  checked value="2">
                                                    ...
                                                    <?php }else if($voucher_details->voucher_type == 1){ ?>
                                                           <input type="radio" id="product_voucher_type" name="voucher_type"   value="2">
                                                           <label for="html">Product Voucher</label><br>
                                                                &nbsp;&nbsp;
                                                           <input type="radio" id="shop_voucher_type" name="voucher_type" checked  value="1">
                                                           <label for="html">Shop Voucher</label><br>
                                                    <?php }else{ ?>
                                                           <input type="radio" id="product_voucher_type" name="voucher_type"  value="2">
                                                           <label for="html">Product Voucher</label><br>
                                ...
                                <div class="row">
                                        <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?= $voucher_details->voucher_name ?>" class="form-control required_fields" name="voucher_name" id="voucher_name">
                                                </div>
                                        </div>
                                 </div>
                                 <div class="row">
                                        <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?= $voucher_details->voucher_code ?>"  class="form-control required_fields" name="voucher_code" id="voucher_code" readonly>
                                                </div>
                                        </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-10">
                                            ...
                                            <input type="datetime-local"  class="form-control" style="z-index: 2 !important; text-align:center;" value="<?php echo date('Y-m-d\TH:i:s', strtotime($voucher_details->start_date)); ?>" id="date_from" name="date_from" >
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-10">
                                            <label for="date_valid" class="control-label">Valid Until:</label>    
                                            <input type="datetime-local" class="form-control" style="z-index: 2 !important; text-align:center;" value="<?php echo date('Y-m-d\TH:i:s', strtotime($voucher_details->end_date)); ?>" id="date_to" name="date_to"  >
                                    </div>
                                 </div>
                                 <br>
                                 ...
                                 <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <div class="input-group" >
                                            ...
                                            <?php  if($voucher_details->disc_amount_type == 1){?>
                                                    <option value="1" Selected>Fixed Rate</option>
                                                    <option value="2" >Percentage Rate</option>
                                            <?php }else{?>
                                                    <option value="1" >Fixed Rate</option>
                                                    <option value="2" Selected>Percentage Rate</option>
                                             <?php } ?>
                                            </select>
                                            <input type="number" value="<?= $voucher_details->disc_amount ?>" class="form-control required_fields" name="disc_ammount" id="disc_ammount"  size="50">
                                 ...
                                 <div class="row" style="display: none;" id="maximum_discount_price">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php  if($voucher_details->max_discount_isset == 1){?>
                                                  <input type="radio" id="set_amount_limit" name="set_amount_limit" checked value="1">
                                            ...
                                            <?php }else if($voucher_details->max_discount_isset == 2) {?>
                                                  <input type="radio" id="set_amount_limit" name="set_amount_limit"  value="1">
                                                  <label for="html">Set Amount</label><br>
                                                  &nbsp;&nbsp;
                                                  <input type="radio" id="set_amount_limit" name="set_amount_limit" checked value="2">
                                                  <label for="html"> No limit</label><br>
                                            <?php }else{ ?>
                                                  <input type="radio" id="set_amount_limit" name="set_amount_limit"  value="1">
                                                  <label for="html">Set Amount</label><br>
                                            ...
                                            <div class="col-md-6" style="display: none;" id="disc_ammountdiv"> 
                                                 <input  type="number" value="<?= $voucher_details->max_discount_price ?>"  class="form-control required_fields" name="disc_ammount_limit" id="disc_ammount_limit"  size="10">
                                            </div>
                                 ...
                                 <div class="row" >
                                    <div class="col-md-10" >
                                            ...
                                            <input type="number" value="<?= $voucher_details->minimum_basket_price ?>"  class="form-control required_fields" name="minimum_basket_price" id="minimum_basket_price">
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-10">
                                            ...
                                            <input type="number"  value="<?= $voucher_details->usage_quantity ?>"  class="form-control required_fields" name="usage_quantity" id="usage_quantity">
                                    </div>
                                 </div>
                                 ...
                                 <br>
                                 <div class="row">
                                 <div class="col-md-10"  id="table-shop-div">
                                           <table class="table wrap-btn-last-td table-striped table-hover table-bordered display nowrap" id="table-shop">
                                               ...
                                               <tbody id='tbody_shops' class='tbody_shops maintbody'>
                                                   <?php $shop_id =  explode(',' , $voucher_details->shop_id); ?>
                                                   <?php foreach($shop_id as $value){ ?>
                                                    <?php  $value = trim($value, '{}') ?>
                                                        <?php if( $value != 0){?>
                                                            <tr class="shop_tr_<?= $value?>">
                                                               <td class="shop_tr_<?= $value?>" width='12%'><?= $value; ?><input type='text' class='ddate' name='shop_id[]' style='display:none' value="<?= $value ?>"></td>
                                                               <td class="shop_tr_<?= $value?>"  style='text-align: center;' width='8%'> <button type='button' id='removeShop' class='btn btn-danger mb-2' data-value="<?= $value?>"><i class='fa fa-trash'></i></button></td>
                                                            </tr>
                                                        <?php } ?>
                                                    <?php } ?>
                                             </tbody>
                                 ...
                                 <br>
                                 <div class="row">
                                 <div class="col-md-10"  id="table-product-div">
                                           <table class="table wrap-btn-last-td table-striped table-hover table-bordered display nowrap "  id="table-product">
                                               ...
                                               <?php $product_id =  explode(',' , $voucher_details->product_id); ?>
                                                   <?php foreach($product_id as $value){ ?>
                                                       <?php if( $value != 0){?>
                                                            <tr class="product_tr_<?= $value?>">
                                                                <td class="product_tr_<?= $value?>" width='12%'><?= $value ?><input type='text' class='ddate' name='product_id[]' style='display:none' value="<?= $value ?>"><input type='text' class='ddate' name='product_id[]' style='display:none' value="<?= $value ?>"></td>
                                                                <td class="product_tr_<?= $value?>"  style='text-align: center;' width='8%'> <button type='button' id='removeProdPromo' class='btn btn-danger mb-2' data-value="<?= $value?>"><i class='fa fa-trash'></i></button></td>
                                                            </tr>
                                                        <?php } ?>
                                                    <?php } ?>
...
<script type="text/javascript" src="<?=base_url('assets/js/promotion/vouchers_promotion_edit.js');?>"></script>
