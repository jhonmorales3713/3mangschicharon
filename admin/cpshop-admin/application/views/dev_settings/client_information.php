                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">Client Information</h3>
                        </div>
                    ...
                    <div class="col-md-auto table-search-container">
                        <div class="row no-gutters">
                            <div class="col-12 col-md-auto">
                                <div class="row no-gutters">
                                    <?php if($this->loginstate->get_access()['client_information']['create'] == 1){ ?>
...
<script type="text/javascript" src="<?=base_url('assets/js/developer_settings/client_information.js');?>"></script>
