                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">Cron Logs</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="cron_name" class="form-control material_josh form-control-sm search-input-text url enter_search" placeholder="Name">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="cron_desc" class="form-control material_josh form-control-sm search-input-text enter_search" placeholder="Description">
                            </div>
                        </div>
...
<div class="modal fade" id="add_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header secondary-bg white-text d-flex align-items-center">
                <h3 class="modal-title" id="exampleModalLabel">Add Content Navigation</h3>
            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/developer_settings/cron_logs.js');?>"></script>
