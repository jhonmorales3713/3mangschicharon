...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products">
    ...
    <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Pandabooks Api Logs</li>
        </ol>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">Pandabooks Api Logs</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" name="_reference_number" class="form-control material_josh form-control-sm search-input-text enter_search" placeholder="Reference Number">
                            </div>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-3" style="display: none;">
                            <div class="form-group">
                                <input type="text" name="_name" class="form-control material_josh form-control-sm search-input-text enter_search" placeholder="Username/IP Address">
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-auto">
                                <div class="row no-gutters">                                    
                                    <div class="col-6 col-md-auto px-1">                                        
                                        <form action="<?=base_url('developer_settings/Dev_settings_pandabooks_api_logs/pandabooks_api_logs_export')?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets/js/developer_settings/pandabooks_api_logs.js');?>"></script>
