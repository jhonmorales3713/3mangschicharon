        ...
        <div class="row">
            <div class="col">
                <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
                    ...
                    <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
                    <li class="breadcrumb-item active">Add Client Information</li>
                </ol>
            </div>
            <!--
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form id="form_save" enctype="multipart/form-data" method="post" action="" data-create_url = "<?= base_url().'developer_settings/Dev_settings_client_information/create'; ?>" data-update_url="<?= base_url().'developer_settings/Dev_settings_client_information/update'; ?>" >
                    <div class="card-body">
                    <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="f_code" class="control-label">Name</label>
                                    <input type="text" class="form-control" name="f_c_name" id="f_c_name" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="f_name" class="control-label">Initial</label>
                                    <input type="text" class="form-control" name="f_c_initial" id="f_c_initial" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label for="f_name" class="control-label">ID Key</label>
                                    <input type="text" class="form-control" name="f_id_key" id="f_id_key" >
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                ...
                <div class="card-body">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="control-label">Favicon<small> (Please upload .ico files only)</small></label>
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none" name="c_allow_login" id="c_allow_login"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_shop_page" id="c_allow_shop_page"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_facebook_login" id="c_allow_facebook_login"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_gmail_login" id="c_allow_gmail_login"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_connect_as_online_reseller" id="c_allow_connect_as_online_reseller"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_physical_login" id="c_allow_physical_login"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_continue_as_guest_button" id="c_continue_as_guest_button"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_registration" id="c_allow_registration"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_default_order" id="c_default_order"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_sms" id="c_allow_sms"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
                        ...
                        <div class="col-4">
                            <div class="toggle-switch">
                                ...
                                <input type="text" style="display:none;" name="c_allow_cod" id="c_allow_cod"> 
                                <label class="switch">                                    
                                    <input type="checkbox">
                                    <span class="slider round"></span>
                                </label>
...
<script type="text/javascript" src="<?=base_url('assets/js/developer_settings/add_client_information.js');?>"></script>