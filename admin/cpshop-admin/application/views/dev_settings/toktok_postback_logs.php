...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products">
    ...
    <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">API Postback Logs</li>
        </ol>
    </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">API Postback Logs</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" name="search" class="form-control material_josh form-control-sm search-input-text enter_search" placeholder="Reference Num">
                            </div>
                        </div>
                    </div>
                    </form>
                ...
                <div class="card-body table-body">
                    <div class=" col-md-auto col-lg-auto table-search-container text-right">
                        <div class="row no-gutters">
                            <div class="col-12">
                                <div class="row no-gutters">                                    
                                    <div class="col-6 col-md-auto px-1">                                        
                                        <form action="<?=base_url('developer_settings/Dev_settings/postback_logs_tbl_export')?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets/js/developer_settings/toktok_postback_logs.js');?>"></script>
