                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title mb-0">Content Navigation</h3>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select name="_main_nav" class="form-control material_josh form-control-sm search-input-text enter_search">
                                    <option value="">All Navigations</option>
                    ...
                    <div class="col-lg-auto table-search-container">
                        <div class="row no-gutters">
                            <div class="col-12 col-md-auto px-1 mb-3">
                                <button data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#add_modal" class="btn-mobile-w-100 mx-0 mx-sm-2 btn btn-outline-danger btnClickAddArea">Add</button>
                            </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/developer_settings/content_navigation.js');?>"></script>
