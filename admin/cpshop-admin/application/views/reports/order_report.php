                ...
                <div class="px-4 py-3 pb-md-0" id="card-header_search" data-show="1">
                    ...
                    <div class="row">
                        ...
                        <div class="search-filter col-lg-6 col-xs-12 col-md-7 col-sm-7 row m-0">
                            ...
                            <div class="my-2 my-md-0 text-xs font-semibold text-orange-400 pt-2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i>&nbsp;You cannot pick more than 1 month of data. Pick End Date First.</div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <select class="form-control" id="select_status">
                                ...
                                <option value="dc">Delivery Confirmed</option>
                ...
                <div class="card-body table-body">
                    <div class="col-md-auto table-search-container">
                        <div class="row no-gutters">
                            ...
                            <form action="<?php echo base_url('order_report/export_order_report');?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/order_report.js');?>"></script>
