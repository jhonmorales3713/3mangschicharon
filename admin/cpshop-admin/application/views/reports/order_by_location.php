...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Orders By Location</li>
        </ol>
    </div>
            ...
            <div class="card" id = "main_body">
                            ...
                            <div class="col-lg-2 col-md-3">
                              <div class="form-group">
                                  ...
                                  <select name="location" id = "location" class="form-control material_josh form-control-sm search-input-text enter_search">
                                    <option value="city" <?=($oblr_filter=='city') ? 'selected':'';?>>City</option>
                                    <option value="prov" <?=($oblr_filter=='prov') ? 'selected':'';?>>Province</option>
                                    <option value="reg" <?=($oblr_filter=='reg') ? 'selected':'';?>>Region</option>
                                  </select>
                              </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Order_by_location/export_oblr_data')?>" method="post" target="_blank">
                    ...
                    <div id="data-container">
                        <div id="salesChart" class="chartWrapper mb-2 collapse show">
                            <div class="card-body chartAreaWrapper" style="box-shadow: 0 0 0 0 !important;">
                                <canvas id="oblrChart" height="300" width="0" style = "border:none;"></canvas>
                            </div>
                        </div>
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\order_by_location.js');?>"></script>
