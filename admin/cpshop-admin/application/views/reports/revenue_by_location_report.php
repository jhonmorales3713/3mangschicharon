...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Revenue By Location</li>
        </ol>
    </div>
            ...
            <div class="card" id = "main_body">
                    ...
                    <div class="row">
                        ...
                        <div style="margin-right: 15px;">
                            <p class="border-search_hideshow p-0 mb-0 d-flex align-items-center justify-content-end">
                                ...
                                <a style="display: none;" href="#" id="chart_toggle1">Show Chart <i class="fa fa-chevron-circle-down fa-lg" aria-hidden="true"></i></a>                       
                            </p>                           
                        </div>
                    </div>
                </div>
                <div class="px-4 pt-3 pb-3 pb-md-0" id="card-header_search" data-show="1">
                    <form id="form_search">
                      <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 pb-3" id="datepicker2" style = "display:none;">
                            ...
                            <div class="col-lg-2 col-md-3">
                              <div class="form-group">
                                  <!-- <label class="form-control-label col-form-label-sm">Status</label> -->
                                  <select name="location" id = "location" class="form-control material_josh form-control-sm search-input-text enter_search">
                                    <option value="city" <?=($rbl_filter=='city') ? 'selected':'';?>>City</option>
                                    <option value="prov" <?=($rbl_filter=='prov') ? 'selected':'';?>>Province</option>
                                    <option value="reg" <?=($rbl_filter=='reg') ? 'selected':'';?>>Region</option>
                                  </select>
                              </div>
                            </div>
                          ...
                          <div id="select_branch_container" class="col-lg-2 col-md-6" style="display: none;">
                              <div class="form-group">
                                  <!-- <label class="form-control-label col-form-label-sm">Shops</label> -->
                ...
                <div class="card-body">
                    <div class="flex-right">
                        <form action="<?=base_url('reports/revenue_by_store/export_rbl_data')?>" method="post" target="_blank">
                    ...
                    <div id="data-container">
                        <div id="salesChart" class="chartWrapper mb-2 collapse show">
                            <div class="card-body chartAreaWrapper" style="box-shadow: 0 0 0 0 !important;">
                                <canvas id="rbl_chart" height="300" width="0" style = "border:none;"></canvas>
                            </div>
                        </div>
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\revenue_by_location_report.js');?>"></script>
