...
<div class="content-inner" id="pageActive" data-num="7" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            <li class="breadcrumb-item active"><a href="<?= base_url('Order_status/shop_branch_pending_orders_list/'.$shop_id.'/'.$branch_id.'/'.$token); ?>"><?= $shopname; ?></a></li>
            <li><i class="fa fa-chevron-right mx-2 white-text" aria-hidden="true"></i></li>
            ...
            <div class="card" id = "main_body">
                ...
                <div class="card-body">        
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Order_status/export_shop_branch_pending_orders_in_date_table/'.$branch_id)?>" method="post" target="_blank">
                    ...
                    <div id="data-container">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <label class="green-text font-weight-bold"><?= date('M d, Y',strtotime($payment_date)); ?></label>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <table class="table table-striped table-hover table-bordered" style="width:100%" id="table-grid">
                            ...
                            <tfoot>
                            <tr class="b">
                                <td class="align-right">Total Orders</td>
                                <td id="t_count"></td>
...
<input type="hidden" name="paymentdate" id="payment_date" value="<?=$payment_date?>">
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\order_status_order_list.js');?>"></script>
