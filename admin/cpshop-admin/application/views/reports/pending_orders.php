...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Pending Orders Report</li>
        </ol>
    </div>
            ...
            <div class="card" id = "main_body">
                ...
                <div class="px-4 pt-3 pb-3 pb-md-0" id="card-header_search" data-show="1">
                    <form id="form_search">
                      <div class="row">
                          ...
                          <div id="select_branch_container" class="col-md-3" style="display: none;">
                              <div class="form-group">
                                  <!-- <label class="form-control-label col-form-label-sm">Shops</label> -->
                ...
                <div class="card-body">
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Pending_orders/export_pending_orders_data')?>" method="post" target="_blank">
                    ...
                    <div id="data-container">
                        <div id="salesChart" class="chartWrapper mb-2 collapse show">
                            <div class="card card-body chartAreaWrapper" style="box-shadow: 0 0 0 0 !important;">
                                <canvas id="poChart" height="300" width="0" style = "border:none;"></canvas>
                            </div>
                        </div>
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\pending_orders.js');?>"></script>
