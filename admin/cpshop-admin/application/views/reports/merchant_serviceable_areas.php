...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Shops"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Merchant Serviceable Areas</li>
        </ol>
    </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="select2 form-control form-control-sm form-state taginput-field" name="_city">
                                    ...
                                    <?php select_option_msa($city, 'city') ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="col-md-auto table-search-container">
                        <div class="row no-gutters">
                            ...
                            <div class="col-12 col-md-auto px-1 mb-3">
                                <div class="row no-gutters">
                                    <div class="col-12 col-md-auto px-1 mb-3">
                                        <form action="<?=base_url('merchant_serviceable_areas/export_merchant_serviceable_areas_list')?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets/js/reports/merchant_serviceable_areas.js');?>"></script>
