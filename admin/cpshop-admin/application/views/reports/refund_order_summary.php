...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Refund Order Summary</li>
        </ol>
    </div>
            ...
            <div class="card" id = "main_body">
                ...
                <div class="card-body">
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Refund_Order/export_refund_summary_table')?>" method="post" target="_blank">
                    ...
                    <div id="data-container">
                        ...
                        <table class="table table-striped table-hover table-bordered table-responsive summary" id="table-grid">
                        <!-- <colgroup>
                            <col style="width:10%;">
                            <col style="width:15%;">
                            <col style="width:8%;">
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\refund_order_summary.js');?>"></script>
