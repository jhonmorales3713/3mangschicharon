...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Product Releasing Report</li>
        </ol>
    </div>
            ...
            <div class="card" id = "main_body">
                ...
                <div class="px-6 pt-3 pb-3 pb-md-0" id="card-header_search" data-show="1">
                    <form id="form_search">
                      <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select name="release_type" id = "release_type" class="form-control material_josh form-control-sm search-input-text enter_search">
               ...
               <div class="card-body"> 
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Product_releasing/export_product_releasing_table')?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\product_releasing.js');?>"></script>
