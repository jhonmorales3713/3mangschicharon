            ...
            <div class="card" id = "main_body">
                ...
                <div class="card-body">
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Total_orders/export_total_orders_table')?>" method="post" target="_blank">
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\total_orders.js');?>"></script>
