...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Reports">
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Inventory List Report</li>
        </ol>
    </div>
            ...
            <div class="card" id = "main_body">
                      ...
                      <div class="row">
                            <div class="col-lg-2 col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="search_val" id="search_val" aria-describedby="helpId" placeholder="Item Name">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-2 pb-3" id="datepicker2" style = "display:none;">
                          ...
                          <div id="select_branch_container" class="col-lg-3 col-md-6" style="display: none;">
                              <div class="form-group">
                                  <!-- <label class="form-control-label col-form-label-sm">Shops</label> -->
                ...
                <div class="card-body">
                    <div class="flex-right">
                        <form action="<?=base_url('reports/Inventory_list/export_invlist_data')?>" method="post" target="_blank">
                    ...
                    <div id="data-container">
                        <div id="salesChart" class="chartWrapper mb-2 collapse show">
                            <div class="card card-body chartAreaWrapper" style="box-shadow: 0 0 0 0 !important;">
                                <canvas id="invChart" height="400" width="0" style = "border:none;"></canvas>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-bordered table-responsive" id = "table-grid-top" style = "display:none;">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center">Percentage</th>
                                    </tr>
                                    <tr>
                        ...
                        <!-- <colgroup>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>Unit Price</th>
                                    <th>Start Date Qty</th>
                                    <th>Added Qty <br><span class="text-sm asof"></span></th>
                                    <th>No of Stocks</th>
                                    <th>Inv Price</th>
                                    <th>Sales Qty <br><span class="text-sm asof"></span></th>
                                    <th>Total Sales</th>
                                </tr>
                            </thead>
                            <!-- <tfoot>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td id="p" class="font-bold"></td>
                                    <td id="po" class="font-bold"></td>
                                    <td id="rp" class="font-bold"></td>
                                    <td id="bc" class="font-bold"></td>
                                </tr>
                            </tfoot> -->
                        </table>
                    </div>
...
<script type="text/javascript" src="<?=base_url('assets\js\reports\inventory_list.js');?>"></script>
