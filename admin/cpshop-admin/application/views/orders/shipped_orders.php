                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title">Shipped Order List</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                              <select class="form-control" id="select_date">
                                ...
                                <option value="date_shipped" selected>Date Shipped</option>
                        ...
                        <div class="col-md-3 mb-3" style="display:none;">
                            <select class="form-control" id="select_status">
                                ...
                                <option value="s" selected>Shipped</option>
...
<input type="hidden" id="order_status_view" value="shipped">
