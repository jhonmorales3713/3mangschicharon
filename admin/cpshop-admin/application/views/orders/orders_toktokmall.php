...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Merchant Order List</li>
        </ol>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <select class="form-control" id="select_date">
                                <option value="date_order" selected >Date Ordered</option>
                                ...
                                <option value="date_confirmed">Date Delivery Confirmed</option>
                ...
                <div class="card-body table-body">
                    <div class="col-md-auto table-search-container">
                        <div class="row no-gutters">
                            ...
                            <form action="<?php echo base_url('orders/main_orders_toktokmall/export_orders');?>" method="post" target="_blank">
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-md-auto">
                            <div class="col-12 col-md-auto">
                                <div class="my-2 my-md-0 text-xs font-semibold text-orange-400"><i class="fa fa-exclamation-circle" aria-hidden="true"></i>&nbsp;Click search icon to display orders.</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="<?=base_url('assets/js/orders/orders_toktokmall.js');?>"></script>
