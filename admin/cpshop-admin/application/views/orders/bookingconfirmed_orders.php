...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Booking Confirmed Order List</li>
        </ol>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title">Booking Confirmed Order List</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                              <select class="form-control" id="select_date">
                                ...
                                <option value="date_booking_confirmed" selected>Date Booking Confirmed</option>
                        ...
                        <div class="col-md-3 mb-3" style="display:none;">
                            <select class="form-control" id="select_status">
                                ...
                                <option value="bc" selected>Booking Confirmed</option>
...
<input type="hidden" id="order_status_view" value="bookingconfirmed">
