...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">For Pick up Order List</li>
        </ol>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title">For Pick up Order List</h3>
                        </div>
                ...
                <div class="px-4 py-3 pb-md-0" id="card-header_search" data-show="1">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="_forpickup" id="_forpickup" value="fp">
                    ...
                    <div class="col-md-auto table-search-container">
                        <div class="row no-gutters">
                            ...
                            <form action="<?php echo base_url('orders/main_orders/export_orders');?>" method="post" target="_blank">
                                ...
                                <input type="hidden" name="forpickup_export" id="forpickup_export" value="fp">
...
<input type="hidden" id="order_status_view" value="forpickup">
