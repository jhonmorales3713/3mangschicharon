...
<?php
    ...
    if(c_international() == 1 && $shopid == 0){
        ...
        if($shopid != 0){
            if($order_details['hsp']==1){
                $shipping_fee_converted    =    $order_details['osf'];
            }else{
                $shipping_fee_converted    =    $order_details['sf'];
            }
        }else{
            $shipping_fee_converted    =    $order_details['sf'];
        }
        $shipping_fee_converted        = (floatval($shipping_fee_converted != floatval(0))) ? number_format($shipping_fee_converted, 2):'Free Shipping';
    ...
    if(ini() == 'toktokmart' && $order_details['paystatus'] == 1){
                        ...
                        <div class="card customer-card">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-11">
                                        <label id="tm_landmark"><?=str_replace($special_upper, $special_format, $notes);?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-auto d-none d-md-flex justify-content-end">
                                        <div>
                                            ...
                                            <?php if (ini() == 'toktokmart') { ?>
                                                <?php if($order_details['paystatus'] == 1){ ?>
                                                    <?php if($order_details['sales_order_status'] == 'p' && $this->loginstate->get_access()['transactions']['modify'] == 1){?>
                                                        <a href="<?=base_url('Main_orders/orders_modify/'.$token.'/'.$url_ref_num.'/'.$order_status_view);?>"><i class="fa fa-pencil"></i> Modify Order</a>
                                                    <?php } ?>
                                                <?php } ?>
                                            <?php } ?>
                                        </div>
                            ...
                            <div class="card-body px-lg-5">
                                <div class="">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <?php } else { ?>
                                            <div class="col-12 col-md-6">
                                                <label class="">Total Refunded Amount:</label>
                                                <label id="tm_amount" class="green-text font-weight-bold"><?=number_format($refunded_amount_tm, 2);?></label>
                                            </div>
                                        <?php }?>
                                        <!-- <div class="col-12 col-md">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if(ini() == 'toktokmall'){?>
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <label id="tm_referral_code" class="font-weight-bold"><?=$order_type?></label>
                                                </div>
                                            <?php }?>
                                            ...
                                            <div class="row">
                                                ...
                                                <?php if(!empty($modified_order)){?>
                                                    <?php foreach($modified_order as $refund){?>
                                                        <div class="col-md-6" style="font-weight: normal">
                                                            <span><u><?=$refund['product_name']?></u></span>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <span><?=number_format($refund['quantity'], 2)?></span>
                                                        </div>
            ...
            <div class="col-lg-12 col-12 text-right col-md-auto px-1 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php } ?>
                        <?php if($this->loginstate->get_access()['void_record']['process'] == 1 && ini() == 'toktokmart'){ ?>
                            <a type="button" class="btn-mobile-w-100 btn btn-danger voidOrder mb-2 mb-md-0" id="voidOrder" href="<?=base_url('settings/void_record/Settings_void_record/void_order_view/'.$token.'/'.$url_ref_num);?>">Void Order</a>
                        <?php } ?>
                    </div>
                </div>
            </div>
...
async defer></script>
<script type="text/javascript" src="<?=base_url('assets/js/orders/orders_view.js');?>"></script>
