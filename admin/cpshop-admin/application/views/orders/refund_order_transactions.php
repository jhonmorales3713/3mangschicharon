...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Refund Order"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Refund Order Transactions</li>
        </ol>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title">Refund Order Transactions</h3>
                        </div>
                ...
                <div class="px-4 py-3 pb-md-0" id="card-header_search" data-show="1">
                    <form id="form_search">
                        <div class="row">
                            ...
                            <div class="col-lg- col-md-6 pb-3">
...
<script type="text/javascript" src="<?=base_url('assets/js/orders/refund_order_transactions.js');?>"></script>