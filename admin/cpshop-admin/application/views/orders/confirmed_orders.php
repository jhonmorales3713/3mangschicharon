...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Delivery Confirmed Order List</li>
        </ol>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title">Delivery Confirmed Order List</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                              <select class="form-control" id="select_date">
                                <option value="date_order" >Date Ordered</option>
                                <option value="date_fulfilled">Date Fulfilled</option>
                                <option value="date_shipped">Date Shipped</option>
                                <option value="date_processed">Date Processed</option>
                                <option value="date_booking_confirmed">Date Booking Confirmed</option>
                                <option value="date_confirmed" selected>Date Delivery Confirmed</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <select class="form-control" id="_isconfirmed" name="_isconfirmed">
                                <option value="1" selected>Order Confirmed</option>
                                <option value="0">To Confirm</option>
                            </select>
                        </div>

                        <!-- <input type="hidden" name="_isconfirmed" id="_isconfirmed" value="oc"> -->
                ...
                <div class="card-body table-body">
                    <div class="col-md-auto table-search-container">
                        <div class="row no-gutters">
                            ...
                            <form action="<?php echo base_url('orders/main_orders/export_orders');?>" method="post" target="_blank">
                                ...
                                <input type="hidden" name="isconfirmed_export" id="isconfirmed_export">
                    ...
                    <table class="table wrap-btn-last-td table-striped table-hover table-bordered display nowrap" style="width:100%" id="table-grid-order"  cellpadding="0" cellspacing="0" border="0">
                        <thead>
                            <tr>
                                <th><input  style="display: none;" type='checkbox' name="check_all_items" id='check_all_items' /></th>
                                <th>Date</th>
                                <th>Order</th>
                                <th>Customer</th>
                                <th>Contact No.</th>
                    ...
                    <div class="row no-gutters  pull-right" style="display: none;" id="showButton">
                        <div class="col-6 col-md-auto px-1 mb-3">
                            <button class="btn btn-success ConfirmedAll" type="button" id="ConfirmedAll"> Batch Delivery Confirmed</button>
                        </div>
                    </div>
                </div>
            </div>
...
<input type="hidden" id="order_status_view" value="confirmed">
<!-- start - load the footer here and some specific js -->
<?php $this->load->view('includes/footer');?> <!-- includes your footer -->
<script type="text/javascript" src="<?=base_url('assets/js/orders/delivery_confirmed.js');?>"></script>
