...
<div class="content-inner" id="pageActive" data-num="<?=$main_nav_id;?>" data-namecollapse="" data-labelname="Products"> 
    <div class="bc-icons-2 card mb-4">
        <ol class="breadcrumb mb-0 primary-bg px-4 py-3">
            ...
            <li class="breadcrumb-item active">Return to Sender Order List</li>
        </ol>
    </div>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col d-flex align-items-center">
                            <h3 class="card-title">Return to Sender Order List</h3>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3" style="display:none;">
                            <select class="form-control" id="select_status">
                                ...
                                <option value="rs" selected>Return to Sender</option>
...
<input type="hidden" id="order_status_view" value="returntosender">
