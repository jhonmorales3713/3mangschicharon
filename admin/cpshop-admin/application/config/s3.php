...
$config['access_key'] = 'AKIARO2UEYLZ7JOXMXJC';
...
$config['secret_key'] = '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';
...
switch (ENVIRONMENT) {
    case 'development':
        $config['bucket_name'] = 'stgtokmall';
    break;
    case 'testing':
        $config['bucket_name'] = 'stgtokmall';
    break;
    case 'production':
        $config['bucket_name'] = 'tokmall';
    break;
}
