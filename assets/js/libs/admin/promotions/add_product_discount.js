$(function(){
    ...
    $.ajax({
        type: 'post',
        url: base_url+'admin/Main_promotions/clear_selectedproducts',
        data: form_data,
        contentType: false,   
        cache: false,      
        processData:false,
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                if(json_data.success) {
                    ...
                    sys_toast_success(json_data.message);
                    // console.log(base_url+"admin/Main_promotions/products_discount_list/"+token);
                
                    window.location.assign(base_url+"Main_promotions/products_discount_list/"+token);
                }else{
